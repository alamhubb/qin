...
/**
 * Smoke test for declaration early-return lowering into conditional builtin IR.
 */
public final class QinDeclarationIrEarlyReturnSmokeTestMain {
    private QinDeclarationIrEarlyReturnSmokeTestMain() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!(choose.returnExpression() instanceof QinIrBuiltinCallExpression builtin)
            ...
            throw new IllegalStateException("Expected conditional builtin from early return, got " + choose.returnExpression());
        }

        System.out.println("QinDeclarationIrEarlyReturnSmokeTestMain passed.");
    }
}
