...
- The `qin.config.js` management guarantee is verified for the current
  ...
  matched against explicit legacy/demo exceptions so unmanaged package projects
  cannot appear silently. This still does not cover every nested experimental
