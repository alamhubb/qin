...
- The `qin.config.js` management guarantee is verified for the current
  ...
  Qin-managed so unmanaged package projects cannot appear silently. This still does not cover every nested experimental
