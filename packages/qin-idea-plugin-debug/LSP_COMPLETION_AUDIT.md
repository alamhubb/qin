...
- JVM `.class` execution is proven by the current focused CLI corpus and
  ...
  execution and parsed multi-class local DTO access, not by every Qin fullstack example,
