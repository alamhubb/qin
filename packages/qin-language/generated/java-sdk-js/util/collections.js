...
const __qin_java_array_deque_remove_first_marker = {};
...
export class __QinJavaUtilArrayDeque {
  ...
  remove(value = __qin_java_array_deque_remove_first_marker) {
    if (value === __qin_java_array_deque_remove_first_marker) {
      return this.removeFirst();
    }
