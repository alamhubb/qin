  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 1: {
        ...
        super(sourceCode);
        this.__qin_constructor_com_slime_java_identifier_JavaIdentifierParser_1(sourceCode);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaIdentifierParser/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_identifier_JavaIdentifierParser_1(sourceCode: string): void {
    null;
  }
  identifier(): any {
