...
class com_slime_java_base_JavaParserBase extends com_subhuti_parser_SubhutiParser {
  static __qin_field_CONTEXTUAL_KEYWORDS: __QinJavaUtilSet<string> | null = null as any;
  ...
  consumeContextual(value: string): com_subhuti_struct_SubhutiCst {
    let current: com_subhuti_struct_SubhutiMatchToken = this.curToken();
    ...
    {
      const __qin_typed_receiver_3329: com_slime_java_base_JavaParserBase = this;
      __qin_typed_receiver_3329.setParseFail();
    }
    return null;
  }
  isContextualKeyword(value: string): boolean {
    return __qin_collection_contains__(com_slime_java_base_JavaParserBase.__qin_field_CONTEXTUAL_KEYWORDS, value);
  }
  ...
  lookahead(offset: number, tokenName: string): boolean {
