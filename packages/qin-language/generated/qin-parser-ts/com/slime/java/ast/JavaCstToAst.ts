...
class com_slime_java_ast_JavaCstToAst {
  ...
  static lowerIfStatement(ifStatement: com_subhuti_struct_SubhutiCst): any {
    return new com_slime_java_ast_JavaAstIfStatement(com_slime_java_ast_JavaCstToAst.lowerExpression(com_slime_java_ast_JavaCstToAst.child(com_slime_java_ast_JavaCstToAst.child(ifStatement, "parExpression"), "expression")), (() => {
      if (__QinJavaLangString.isEmpty(com_slime_java_ast_JavaCstToAst.children(ifStatement, "statement"))) {
        return __QinJavaUtilList.of();
      }
  ...
  static lowerWhileStatement(whileStatement: com_subhuti_struct_SubhutiCst): any {
    return new com_slime_java_ast_JavaAstWhileStatement(com_slime_java_ast_JavaCstToAst.lowerExpression(com_slime_java_ast_JavaCstToAst.child(com_slime_java_ast_JavaCstToAst.child(whileStatement, "parExpression"), "expression")), (() => {
      if (__QinJavaLangString.isEmpty(com_slime_java_ast_JavaCstToAst.children(whileStatement, "statement"))) {
        return __QinJavaUtilList.of();
      }
  ...
  static lowerDoWhileStatement(doWhileStatement: com_subhuti_struct_SubhutiCst): any {
    return new com_slime_java_ast_JavaAstDoWhileStatement((() => {
      if (__QinJavaLangString.isEmpty(com_slime_java_ast_JavaCstToAst.children(doWhileStatement, "statement"))) {
        return __QinJavaUtilList.of();
      }
  ...
  static lowerTryStatement(tryStatement: com_subhuti_struct_SubhutiCst): any {
    ...
    let tryStatements: any = (() => {
      if (__QinJavaLangString.isEmpty(blocks)) {
        return __QinJavaUtilList.of();
      }
  ...
  static lowerSwitchBlockStatementGroup(group: com_subhuti_struct_SubhutiCst): any {
    ...
    if (__QinJavaLangString.isEmpty(labels)) {
      return __QinJavaUtilList.of(new com_slime_java_ast_JavaAstSwitchCase(null, statements));
    }
    let cases: any = new __QinJavaUtilArrayList();
    for (let i: any = 0.0; __qin_binary__("<", i, labels.size()); i = __qin_binary__("+", i, 1.0)) {
  ...
  static lowerSwitchRule(rule: com_subhuti_struct_SubhutiCst): any {
    ...
    let tests: any = com_slime_java_ast_JavaCstToAst.lowerExpressionList(expressionList);
    if (__QinJavaLangString.isEmpty(tests)) {
      return __QinJavaUtilList.of(new com_slime_java_ast_JavaAstSwitchCase(null, statements));
    }
    let cases: any = new __QinJavaUtilArrayList();
    for (let i: any = 0.0; __qin_binary__("<", i, tests.size()); i = __qin_binary__("+", i, 1.0)) {
  ...
  static lowerForStatement(forStatement: com_subhuti_struct_SubhutiCst): any {
    ...
    if (__qin_binary__("!=", enhancedForControl, null)) {
      ...
      if (__QinJavaLangString.isEmpty(bodyStatements)) {
        return __QinJavaUtilList.of();
      }
  ...
  static lastReturnExpression(statements: any): any {
    ...
    for (let i: any = __qin_binary__("-", statements.size(), 1.0); __qin_binary__(">=", i, 0.0); i = __qin_binary__("-", i, 1.0)) {
      if ((() => { const __qin_pattern_value = statements.get(i); return __qin_pattern_value instanceof com_slime_java_ast_JavaAstReturnStatement && (returnStatement = __qin_pattern_value, true); })()) {
  ...
  static lowerLeftAssociative(node: com_subhuti_struct_SubhutiCst, operatorTokenNames: any): any {
    ...
    for (const child of children) {
      if ((() => {
      if (child.isToken()) {
        return __QinJavaLangString.contains(operatorTokenNames, child.getName());
      }
      return false;
    })()) {
  ...
  static lowerRelationalExpression(node: com_subhuti_struct_SubhutiCst): any {
    ...
    for (const child of children) {
      if ((() => {
      if (child.isToken()) {
        return __QinJavaLangString.contains(__QinJavaUtilList.of("LT", "GT", "LE", "GE", "INSTANCEOF"), child.getName());
      }
      return false;
    })()) {
        operator = child.getValue();
  ...
  static decodeJavaEscapes(text: string, literal: string): any {
    ...
    for (let index: any = 0.0; __qin_binary__("<", index, __QinJavaLangString.length(text)); index = __qin_binary__("+", index, 1.0)) {
      ...
      let escape: any = __QinJavaLangString.charAt(text, index = __qin_binary__("+", index, 1.0));
      switch (escape) {
        case "b":
          out.append("\b");
        case "t":
      ...
      return false;
            ...
            index = __qin_binary__("+", index, 1.0);
          }
  ...
  static lastChild(node: com_subhuti_struct_SubhutiCst, name: string): any {
    return (() => {
      if (__QinJavaLangString.isEmpty(com_slime_java_ast_JavaCstToAst.children(node, name))) {
        return null;
      }
  ...
  static children(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_args[0] instanceof com_subhuti_struct_SubhutiCst) && (__qin_args[1] === null || typeof __qin_args[1] === "string")) return this.__qin_overload_children_2_0(__qin_args[0], __qin_args[1]);
    if (__qin_args.length === 1 && (__qin_args[0] === null || __qin_args[0] instanceof com_subhuti_struct_SubhutiCst)) return this.__qin_overload_children_1_1(__qin_args[0]);
