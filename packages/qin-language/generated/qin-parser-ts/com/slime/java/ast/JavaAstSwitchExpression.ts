...
class com_slime_java_ast_JavaAstSwitchExpression {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.java.ast.JavaAstExpression")) && (__qin_args[1] === null || Array.isArray(__qin_args[1]) || __qin_instanceof__(__qin_args[1], __QinJavaUtilArrayList) || __qin_instanceof__(__qin_args[1], __QinJavaUtilUnmodifiableList))) {
      ...
      this.__qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_2_0(discriminant, cases);
      return;
    }
    throw new Error("Unsupported Java constructor overload: JavaAstSwitchExpression/" + __qin_args.length);
  }
  __qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_2_0(discriminant: com_slime_java_ast_JavaAstExpression, cases: __QinJavaUtilList<com_slime_java_ast_JavaAstSwitchCase>): void {
  ...
  equals(other: any): boolean {
    ...
    const __qin_record_other: com_slime_java_ast_JavaAstSwitchExpression = other;
