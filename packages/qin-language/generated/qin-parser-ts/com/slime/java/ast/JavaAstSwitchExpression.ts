...
class com_slime_java_ast_JavaAstSwitchExpression {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 0 && true) {
      this.__qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_0_0();
      return;
    }
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.java.ast.JavaAstExpression")) && (__qin_args[1] === null || Array.isArray(__qin_args[1]) || __qin_args[1] instanceof __QinJavaUtilArrayList || __qin_args[1] instanceof __QinJavaUtilUnmodifiableList)) {
      ...
      this.__qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_2_1(discriminant, cases);
      return;
    }
    throw new Error("Unsupported Java constructor overload: JavaAstSwitchExpression/" + __qin_args.length);
  }
  __qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_0_0(): void {
  ...
  __qin_constructor_com_slime_java_ast_JavaAstSwitchExpression_2_1(discriminant: com_slime_java_ast_JavaAstExpression, cases: any): void {
    this.__qin_field_discriminant = null;
    this.__qin_field_cases = null;
    (() => {
  ...
  toString() {
    return ["JavaAstSwitchExpression[", "discriminant=", this.__qin_field_discriminant, ", ", "cases=", this.__qin_field_cases, "]"].join("");
  }
}
