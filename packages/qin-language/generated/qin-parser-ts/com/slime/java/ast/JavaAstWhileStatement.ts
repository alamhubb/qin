...
class com_slime_java_ast_JavaAstWhileStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 0: {
        this.__qin_constructor_com_slime_java_ast_JavaAstWhileStatement_0();
        return;
      }
      case 2: {
        const test: any = __qin_args[0];
        const bodyStatements: any = __qin_args[1];
        this.__qin_constructor_com_slime_java_ast_JavaAstWhileStatement_2(test, bodyStatements);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstWhileStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstWhileStatement_0(): void {
  ...
  __qin_constructor_com_slime_java_ast_JavaAstWhileStatement_2(test: com_slime_java_ast_JavaAstExpression, bodyStatements: any): void {
    this.__qin_field_test = null;
    this.__qin_field_bodyStatements = null;
    (() => {
  ...
  toString() {
    return "JavaAstWhileStatement[" + "test=" + this.__qin_field_test + ", " + "bodyStatements=" + this.__qin_field_bodyStatements + "]";
  }
}
