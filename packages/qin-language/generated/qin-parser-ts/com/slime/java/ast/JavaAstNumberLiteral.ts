...
class com_slime_java_ast_JavaAstNumberLiteral {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 1 && typeof __qin_args[0] === "number") {
      ...
      this.__qin_constructor_com_slime_java_ast_JavaAstNumberLiteral_1_0(value);
      return;
    }
    if (__qin_args.length === 2 && typeof __qin_args[0] === "number" && typeof __qin_args[1] === "boolean") {
      const value: any = __qin_args[0];
      const integral: any = __qin_args[1];
      this.__qin_constructor_com_slime_java_ast_JavaAstNumberLiteral_2_1(value, integral);
      return;
    }
    throw new Error("Unsupported Java constructor overload: JavaAstNumberLiteral/" + __qin_args.length);
  }
  __qin_constructor_com_slime_java_ast_JavaAstNumberLiteral_1_0(value: number): void {
