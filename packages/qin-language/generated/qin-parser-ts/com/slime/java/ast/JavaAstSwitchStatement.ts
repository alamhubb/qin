...
class com_slime_java_ast_JavaAstSwitchStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 0: {
        this.__qin_constructor_com_slime_java_ast_JavaAstSwitchStatement_0();
        return;
      }
      case 2: {
        const discriminant: any = __qin_args[0];
        const cases: any = __qin_args[1];
        this.__qin_constructor_com_slime_java_ast_JavaAstSwitchStatement_2(discriminant, cases);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstSwitchStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstSwitchStatement_0(): void {
  ...
  __qin_constructor_com_slime_java_ast_JavaAstSwitchStatement_2(discriminant: com_slime_java_ast_JavaAstExpression, cases: any): void {
    this.__qin_field_discriminant = null;
    this.__qin_field_cases = null;
    (() => {
  ...
  toString() {
    return "JavaAstSwitchStatement[" + "discriminant=" + this.__qin_field_discriminant + ", " + "cases=" + this.__qin_field_cases + "]";
  }
}
com_slime_java_ast_JavaAstSwitchStatement.__qin_java_interfaces = ["com.slime.java.ast.JavaAstStatement"];
const JavaAstSwitchStatement = com_slime_java_ast_JavaAstSwitchStatement;
...
export { com_slime_java_ast_JavaAstSwitchStatement };
