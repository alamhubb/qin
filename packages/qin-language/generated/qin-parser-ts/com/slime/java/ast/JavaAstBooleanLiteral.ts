...
class com_slime_java_ast_JavaAstBooleanLiteral {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 1: {
        ...
        this.__qin_constructor_com_slime_java_ast_JavaAstBooleanLiteral_1(value);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstBooleanLiteral/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstBooleanLiteral_1(value: boolean): void {
  ...
  toString() {
    return "JavaAstBooleanLiteral[" + "value=" + this.__qin_field_value + "]";
  }
}
