...
class com_slime_java_ast_JavaAstTryStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 0: {
        this.__qin_constructor_com_slime_java_ast_JavaAstTryStatement_0();
        return;
      }
      case 3: {
        ...
        this.__qin_constructor_com_slime_java_ast_JavaAstTryStatement_3(tryStatements, catchClauses, finallyStatements);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstTryStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstTryStatement_0(): void {
  ...
  __qin_constructor_com_slime_java_ast_JavaAstTryStatement_3(tryStatements: any, catchClauses: any, finallyStatements: any): void {
    this.__qin_field_tryStatements = null;
    this.__qin_field_catchClauses = null;
    this.__qin_field_finallyStatements = null;
    (() => {
  ...
  equals(other) {
    ...
    return __qin_java_values_equal__(this.__qin_field_tryStatements, other.__qin_field_tryStatements)
  ...
  toString() {
    return "JavaAstTryStatement[" + "tryStatements=" + this.__qin_field_tryStatements + ", " + "catchClauses=" + this.__qin_field_catchClauses + ", " + "finallyStatements=" + this.__qin_field_finallyStatements + "]";
  }
}
