...
class com_slime_java_ast_JavaAstReturnStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 1: {
        ...
        this.__qin_constructor_com_slime_java_ast_JavaAstReturnStatement_1(expression);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstReturnStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstReturnStatement_1(expression: com_slime_java_ast_JavaAstExpression): void {
  ...
  toString() {
    return "JavaAstReturnStatement[" + "expression=" + this.__qin_field_expression + "]";
  }
}
