...
class com_slime_java_ast_JavaAstStringLiteral {
  __qin_field_value: string | null = null as any;
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 1: {
        const value: any = __qin_args[0];
        this.__qin_constructor_com_slime_java_ast_JavaAstStringLiteral_1(value);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: JavaAstStringLiteral/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_java_ast_JavaAstStringLiteral_1(value: string): void {
  ...
  toString() {
    return "JavaAstStringLiteral[" + "value=" + this.__qin_field_value + "]";
  }
}
com_slime_java_ast_JavaAstStringLiteral.__qin_java_interfaces = ["com.slime.java.ast.JavaAstExpression"];
const JavaAstStringLiteral = com_slime_java_ast_JavaAstStringLiteral;
...
export { com_slime_java_ast_JavaAstStringLiteral };
