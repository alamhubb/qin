...
class com_slime_java_ast_JavaAstStringLiteral {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 1 && (__qin_args[0] === null || typeof __qin_args[0] === "string")) {
      ...
      this.__qin_constructor_com_slime_java_ast_JavaAstStringLiteral_1_0(value);
      return;
    }
    throw new Error("Unsupported Java constructor overload: JavaAstStringLiteral/" + __qin_args.length);
  }
  __qin_constructor_com_slime_java_ast_JavaAstStringLiteral_1_0(value: string): void {
