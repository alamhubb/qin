...
class com_slime_ast_nodes_expressions_ArrayExpression {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_expressions_ArrayExpression_2(elements, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ArrayExpression/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_expressions_ArrayExpression_2(elements: any, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ArrayExpression[" + "elements=" + this.__qin_field_elements + ", " + "location=" + this.__qin_field_location + "]";
  }
}
