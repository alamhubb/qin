...
class com_slime_ast_nodes_typescript_TSTypeReference {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 3: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_typescript_TSTypeReference_3(typeName, typeParameters, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: TSTypeReference/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSTypeReference_3(typeName: com_slime_ast_AstNode, typeParameters: com_slime_ast_AstNode, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "TSTypeReference[" + "typeName=" + this.__qin_field_typeName + ", " + "typeParameters=" + this.__qin_field_typeParameters + ", " + "location=" + this.__qin_field_location + "]";
  }
}
