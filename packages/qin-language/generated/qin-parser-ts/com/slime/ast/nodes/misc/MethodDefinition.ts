...
class com_slime_ast_nodes_misc_MethodDefinition {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 9: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_misc_MethodDefinition_9(key, value, kind, computed, isStatic, decorators, accessibility, override, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: MethodDefinition/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_misc_MethodDefinition_9(key: com_slime_ast_AstNode, value: com_slime_ast_nodes_expressions_FunctionExpression, kind: string, computed: boolean, isStatic: boolean, decorators: any, accessibility: string, override: boolean, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "MethodDefinition[" + "key=" + this.__qin_field_key + ", " + "value=" + this.__qin_field_value + ", " + "kind=" + this.__qin_field_kind + ", " + "computed=" + this.__qin_field_computed + ", " + "isStatic=" + this.__qin_field_isStatic + ", " + "decorators=" + this.__qin_field_decorators + ", " + "accessibility=" + this.__qin_field_accessibility + ", " + "override=" + this.__qin_field_override + ", " + "location=" + this.__qin_field_location + "]";
  }
}
