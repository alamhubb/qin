...
class com_slime_ast_nodes_statements_LabeledStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 3: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_LabeledStatement_3(label, body, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: LabeledStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_LabeledStatement_3(label: com_slime_ast_nodes_expressions_Identifier, body: com_slime_ast_Statement, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "LabeledStatement[" + "label=" + this.__qin_field_label + ", " + "body=" + this.__qin_field_body + ", " + "location=" + this.__qin_field_location + "]";
  }
}
