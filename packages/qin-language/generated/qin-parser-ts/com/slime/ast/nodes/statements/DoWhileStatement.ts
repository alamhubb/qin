...
class com_slime_ast_nodes_statements_DoWhileStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 3: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_DoWhileStatement_3(body, test, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: DoWhileStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_DoWhileStatement_3(body: com_slime_ast_Statement, test: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "DoWhileStatement[" + "body=" + this.__qin_field_body + ", " + "test=" + this.__qin_field_test + ", " + "location=" + this.__qin_field_location + "]";
  }
}
