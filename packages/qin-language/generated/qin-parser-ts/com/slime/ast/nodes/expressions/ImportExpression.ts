...
class com_slime_ast_nodes_expressions_ImportExpression {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_expressions_ImportExpression_2(source, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ImportExpression/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_expressions_ImportExpression_2(source: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ImportExpression[" + "source=" + this.__qin_field_source + ", " + "location=" + this.__qin_field_location + "]";
  }
}
