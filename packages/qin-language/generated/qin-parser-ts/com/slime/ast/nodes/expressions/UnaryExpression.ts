...
class com_slime_ast_nodes_expressions_UnaryExpression {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 4: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_expressions_UnaryExpression_4(operator, argument, prefix, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: UnaryExpression/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_expressions_UnaryExpression_4(operator: string, argument: com_slime_ast_Expression, prefix: boolean, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "UnaryExpression[" + "operator=" + this.__qin_field_operator + ", " + "argument=" + this.__qin_field_argument + ", " + "prefix=" + this.__qin_field_prefix + ", " + "location=" + this.__qin_field_location + "]";
  }
}
