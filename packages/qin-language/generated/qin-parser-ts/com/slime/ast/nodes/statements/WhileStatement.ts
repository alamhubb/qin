...
class com_slime_ast_nodes_statements_WhileStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 3: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_WhileStatement_3(test, body, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: WhileStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_WhileStatement_3(test: com_slime_ast_Expression, body: com_slime_ast_Statement, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "WhileStatement[" + "test=" + this.__qin_field_test + ", " + "body=" + this.__qin_field_body + ", " + "location=" + this.__qin_field_location + "]";
  }
}
