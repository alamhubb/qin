...
class com_slime_ast_nodes_expressions_AssignmentExpression {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 4 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.AstNode")) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Expression")) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation))) {
  ...
  equals(other: any): boolean {
    ...
    const __qin_record_other: com_slime_ast_nodes_expressions_AssignmentExpression = other;
