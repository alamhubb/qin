...
class com_slime_ast_nodes_statements_ExpressionStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_ExpressionStatement_2(expression, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ExpressionStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_ExpressionStatement_2(expression: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ExpressionStatement[" + "expression=" + this.__qin_field_expression + ", " + "location=" + this.__qin_field_location + "]";
  }
}
