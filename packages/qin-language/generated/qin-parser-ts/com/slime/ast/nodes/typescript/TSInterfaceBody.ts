...
class com_slime_ast_nodes_typescript_TSInterfaceBody {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 2 && (__qin_args[0] === null || Array.isArray(__qin_args[0]) || __qin_instanceof__(__qin_args[0], __QinJavaUtilArrayList) || __qin_instanceof__(__qin_args[0], __QinJavaUtilUnmodifiableList)) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation))) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_typescript_TSInterfaceBody_2_0(body, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: TSInterfaceBody/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSInterfaceBody_2_0(body: __QinJavaUtilList<com_slime_ast_AstNode>, location: com_slime_ast_SourceLocation): void {
  ...
  type(): com_slime_ast_AstNodeType {
    return com_slime_ast_AstNodeType.__qin_field_TS_INTERFACE_BODY;
  }
  ...
  equals(other: any): boolean {
    ...
    if (!__qin_instanceof__(other, com_slime_ast_nodes_typescript_TSInterfaceBody)) return false;
    const __qin_record_other: com_slime_ast_nodes_typescript_TSInterfaceBody = other;
  ...
  toString(): string {
    return ["TSInterfaceBody[", "body=", this.__qin_field_body, ", ", "location=", this.__qin_field_location, "]"].join("");
  }
}
com_slime_ast_nodes_typescript_TSInterfaceBody.__qin_java_interfaces = ["com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_typescript_TSInterfaceBody };
