...
class com_slime_ast_nodes_typescript_TSKeywordType {
  __qin_field_keywordType: com_slime_ast_AstNodeType | null = null as any;
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 3: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_typescript_TSKeywordType_3(keywordType, keyword, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: TSKeywordType/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSKeywordType_3(keywordType: com_slime_ast_AstNodeType, keyword: string, location: com_slime_ast_SourceLocation): void {
    this.__qin_field_keywordType = null;
    this.__qin_field_keyword = null;
    this.__qin_field_location = null;
    (() => {
      this.__qin_field_keywordType = keywordType;
      this.__qin_field_keyword = keyword;
  ...
  toString() {
    return "TSKeywordType[" + "keywordType=" + this.__qin_field_keywordType + ", " + "keyword=" + this.__qin_field_keyword + ", " + "location=" + this.__qin_field_location + "]";
  }
}
com_slime_ast_nodes_typescript_TSKeywordType.__qin_java_interfaces = ["com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_typescript_TSKeywordType };
