...
class com_slime_ast_nodes_typescript_TSKeywordType {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_AstNodeType)) && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_typescript_TSKeywordType_3_0(keywordType, keyword, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: TSKeywordType/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSKeywordType_3_0(keywordType: com_slime_ast_AstNodeType, keyword: string, location: com_slime_ast_SourceLocation): void {
