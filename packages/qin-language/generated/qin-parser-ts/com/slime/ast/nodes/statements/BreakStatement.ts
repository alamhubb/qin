...
class com_slime_ast_nodes_statements_BreakStatement {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier)) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation))) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_statements_BreakStatement_2_0(label, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: BreakStatement/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_statements_BreakStatement_2_0(label: com_slime_ast_nodes_expressions_Identifier, location: com_slime_ast_SourceLocation): void {
  ...
  type(): com_slime_ast_AstNodeType {
    return com_slime_ast_AstNodeType.__qin_field_BREAK_STATEMENT;
  }
  ...
  equals(other: any): boolean {
    ...
    if (!__qin_instanceof__(other, com_slime_ast_nodes_statements_BreakStatement)) return false;
    const __qin_record_other: com_slime_ast_nodes_statements_BreakStatement = other;
  ...
  toString(): string {
    return ["BreakStatement[", "label=", this.__qin_field_label, ", ", "location=", this.__qin_field_location, "]"].join("");
  }
}
com_slime_ast_nodes_statements_BreakStatement.__qin_java_interfaces = ["com.slime.ast.Statement", "com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_statements_BreakStatement };
