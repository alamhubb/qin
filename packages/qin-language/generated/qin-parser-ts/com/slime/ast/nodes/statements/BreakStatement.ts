...
class com_slime_ast_nodes_statements_BreakStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_BreakStatement_2(label, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: BreakStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_BreakStatement_2(label: com_slime_ast_nodes_expressions_Identifier, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "BreakStatement[" + "label=" + this.__qin_field_label + ", " + "location=" + this.__qin_field_location + "]";
  }
}
