...
class com_slime_ast_nodes_misc_ClassBody {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_misc_ClassBody_2(body, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ClassBody/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_misc_ClassBody_2(body: any, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ClassBody[" + "body=" + this.__qin_field_body + ", " + "location=" + this.__qin_field_location + "]";
  }
}
