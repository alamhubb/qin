...
class com_slime_ast_nodes_expressions_Identifier {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation))) {
  ...
  equals(other: any): boolean {
    ...
    const __qin_record_other: com_slime_ast_nodes_expressions_Identifier = other;
