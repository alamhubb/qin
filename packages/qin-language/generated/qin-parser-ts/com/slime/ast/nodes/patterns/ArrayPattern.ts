...
class com_slime_ast_nodes_patterns_ArrayPattern {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_patterns_ArrayPattern_2(elements, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ArrayPattern/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_patterns_ArrayPattern_2(elements: any, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ArrayPattern[" + "elements=" + this.__qin_field_elements + ", " + "location=" + this.__qin_field_location + "]";
  }
}
com_slime_ast_nodes_patterns_ArrayPattern.__qin_java_interfaces = ["com.slime.ast.Pattern", "com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_patterns_ArrayPattern };
