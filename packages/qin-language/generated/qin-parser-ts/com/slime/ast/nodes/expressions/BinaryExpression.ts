...
class com_slime_ast_nodes_expressions_BinaryExpression {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 4: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_expressions_BinaryExpression_4(operator, left, right, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: BinaryExpression/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_expressions_BinaryExpression_4(operator: string, left: com_slime_ast_Expression, right: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "BinaryExpression[" + "operator=" + this.__qin_field_operator + ", " + "left=" + this.__qin_field_left + ", " + "right=" + this.__qin_field_right + ", " + "location=" + this.__qin_field_location + "]";
  }
}
