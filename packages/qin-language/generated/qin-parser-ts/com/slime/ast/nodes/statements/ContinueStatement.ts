...
class com_slime_ast_nodes_statements_ContinueStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_ContinueStatement_2(label, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ContinueStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_ContinueStatement_2(label: com_slime_ast_nodes_expressions_Identifier, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ContinueStatement[" + "label=" + this.__qin_field_label + ", " + "location=" + this.__qin_field_location + "]";
  }
}
com_slime_ast_nodes_statements_ContinueStatement.__qin_java_interfaces = ["com.slime.ast.Statement", "com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_statements_ContinueStatement };
