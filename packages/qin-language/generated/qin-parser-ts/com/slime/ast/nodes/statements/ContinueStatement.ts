...
class com_slime_ast_nodes_statements_ContinueStatement {
  ...
  constructor(...__qin_args: any[]) {
    ...
    throw new Error("Unsupported Java constructor overload: ContinueStatement/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_statements_ContinueStatement_2_0(label: com_slime_ast_nodes_expressions_Identifier, location: com_slime_ast_SourceLocation): void {
