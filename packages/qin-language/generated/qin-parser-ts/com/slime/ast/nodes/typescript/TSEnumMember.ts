...
class com_slime_ast_nodes_typescript_TSEnumMember {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.AstNode")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.AstNode")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_typescript_TSEnumMember_3_0(id, initializer, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: TSEnumMember/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSEnumMember_3_0(id: com_slime_ast_AstNode, initializer: com_slime_ast_AstNode, location: com_slime_ast_SourceLocation): void {
