...
class com_slime_ast_nodes_typescript_TSTypeParameterDeclaration {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 2 && (__qin_args[0] === null || Array.isArray(__qin_args[0]) || __qin_instanceof__(__qin_args[0], __QinJavaUtilArrayList) || __qin_instanceof__(__qin_args[0], __QinJavaUtilUnmodifiableList)) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation))) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_typescript_TSTypeParameterDeclaration_2_0(params, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: TSTypeParameterDeclaration/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSTypeParameterDeclaration_2_0(params: __QinJavaUtilList<com_slime_ast_AstNode>, location: com_slime_ast_SourceLocation): void {
  ...
  type(): com_slime_ast_AstNodeType {
    return com_slime_ast_AstNodeType.__qin_field_TS_TYPE_PARAMETER_DECLARATION;
  }
  ...
  equals(other: any): boolean {
    ...
    if (!__qin_instanceof__(other, com_slime_ast_nodes_typescript_TSTypeParameterDeclaration)) return false;
    const __qin_record_other: com_slime_ast_nodes_typescript_TSTypeParameterDeclaration = other;
  ...
  toString(): string {
    return ["TSTypeParameterDeclaration[", "params=", this.__qin_field_params, ", ", "location=", this.__qin_field_location, "]"].join("");
  }
}
com_slime_ast_nodes_typescript_TSTypeParameterDeclaration.__qin_java_interfaces = ["com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_typescript_TSTypeParameterDeclaration };
