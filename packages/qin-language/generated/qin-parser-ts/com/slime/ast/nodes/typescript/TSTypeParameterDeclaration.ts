...
class com_slime_ast_nodes_typescript_TSTypeParameterDeclaration {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_typescript_TSTypeParameterDeclaration_2(params, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: TSTypeParameterDeclaration/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_typescript_TSTypeParameterDeclaration_2(params: any, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "TSTypeParameterDeclaration[" + "params=" + this.__qin_field_params + ", " + "location=" + this.__qin_field_location + "]";
  }
}
