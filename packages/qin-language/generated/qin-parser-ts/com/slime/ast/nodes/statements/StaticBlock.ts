...
class com_slime_ast_nodes_statements_StaticBlock {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 2: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_StaticBlock_2(body, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: StaticBlock/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_StaticBlock_2(body: any, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "StaticBlock[" + "body=" + this.__qin_field_body + ", " + "location=" + this.__qin_field_location + "]";
  }
}
