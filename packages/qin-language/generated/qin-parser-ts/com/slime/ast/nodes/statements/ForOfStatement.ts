...
class com_slime_ast_nodes_statements_ForOfStatement {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.AstNode")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Statement")) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SourceLocation) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) {
      ...
      this.__qin_constructor_com_slime_ast_nodes_statements_ForOfStatement_5_0(left, right, body, __qin_await, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: ForOfStatement/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_statements_ForOfStatement_5_0(left: com_slime_ast_AstNode, right: com_slime_ast_Expression, body: com_slime_ast_Statement, __qin_await: boolean, location: com_slime_ast_SourceLocation): void {
