...
class com_slime_ast_nodes_statements_ForOfStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 5: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_ForOfStatement_5(left, right, body, __qin_await, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ForOfStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_ForOfStatement_5(left: com_slime_ast_AstNode, right: com_slime_ast_Expression, body: com_slime_ast_Statement, __qin_await: boolean, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ForOfStatement[" + "left=" + this.__qin_field_left + ", " + "right=" + this.__qin_field_right + ", " + "body=" + this.__qin_field_body + ", " + "await=" + this.__qin_field___qin_await + ", " + "location=" + this.__qin_field_location + "]";
  }
}
com_slime_ast_nodes_statements_ForOfStatement.__qin_java_interfaces = ["com.slime.ast.Statement", "com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_statements_ForOfStatement };
