  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 9: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_expressions_FunctionExpression_9(id, params, parameterMetadata, body, generator, async, returnType, typeParameters, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: FunctionExpression/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_expressions_FunctionExpression_9(id: com_slime_ast_nodes_expressions_Identifier, params: any, parameterMetadata: any, body: com_slime_ast_nodes_statements_BlockStatement, generator: boolean, async: boolean, returnType: com_slime_ast_AstNode, typeParameters: com_slime_ast_AstNode, location: com_slime_ast_SourceLocation): void {
