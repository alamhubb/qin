...
class com_slime_ast_nodes_statements_ForStatement {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 5: {
        ...
        this.__qin_constructor_com_slime_ast_nodes_statements_ForStatement_5(init, test, update, body, location);
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: ForStatement/" + __qin_args.length);
    }
  }
  __qin_constructor_com_slime_ast_nodes_statements_ForStatement_5(init: com_slime_ast_AstNode, test: com_slime_ast_Expression, update: com_slime_ast_Expression, body: com_slime_ast_Statement, location: com_slime_ast_SourceLocation): void {
  ...
  toString() {
    return "ForStatement[" + "init=" + this.__qin_field_init + ", " + "test=" + this.__qin_field_test + ", " + "update=" + this.__qin_field_update + ", " + "body=" + this.__qin_field_body + ", " + "location=" + this.__qin_field_location + "]";
  }
}
