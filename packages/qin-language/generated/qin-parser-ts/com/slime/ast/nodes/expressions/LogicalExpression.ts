...
class com_slime_ast_nodes_expressions_LogicalExpression {
  ...
  __qin_field_left: com_slime_ast_Expression | null = null as any;
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 4 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Expression")) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation))) {
      const operator: any = __qin_args[0];
      const left: any = __qin_args[1];
      const right: any = __qin_args[2];
      const location: any = __qin_args[3];
      this.__qin_constructor_com_slime_ast_nodes_expressions_LogicalExpression_4_0(operator, left, right, location);
      return;
    }
    throw new Error("Unsupported Java constructor overload: LogicalExpression/" + __qin_args.length);
  }
  __qin_constructor_com_slime_ast_nodes_expressions_LogicalExpression_4_0(operator: string, left: com_slime_ast_Expression, right: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): void {
  ...
  type(): com_slime_ast_AstNodeType {
    return com_slime_ast_AstNodeType.__qin_field_LOGICAL_EXPRESSION;
  }
  operator(): string {
    return this.__qin_field_operator;
  }
  left(): com_slime_ast_Expression {
  ...
  equals(other: any): boolean {
    ...
    if (!__qin_instanceof__(other, com_slime_ast_nodes_expressions_LogicalExpression)) return false;
    const __qin_record_other: com_slime_ast_nodes_expressions_LogicalExpression = other;
  ...
  toString(): string {
    return ["LogicalExpression[", "operator=", this.__qin_field_operator, ", ", "left=", this.__qin_field_left, ", ", "right=", this.__qin_field_right, ", ", "location=", this.__qin_field_location, "]"].join("");
  }
}
com_slime_ast_nodes_expressions_LogicalExpression.__qin_java_interfaces = ["com.slime.ast.Expression", "com.slime.ast.AstNode"];
...
export { com_slime_ast_nodes_expressions_LogicalExpression };
