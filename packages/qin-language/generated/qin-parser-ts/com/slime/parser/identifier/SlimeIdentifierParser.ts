...
class com_slime_parser_identifier_SlimeIdentifierParser extends com_slime_parser_base_SlimeJavascriptParserBase {
  ...
  __qin_subhuti_raw_Identifier(): any {
    ...
    if (com_slime_parser_base_SlimeJavascriptParserBase.__qin_field_RESERVED_WORDS.contains(value)) {
      this.setParseFail();
      return null;
    }
    if (__QinJavaLangString.contains(value, "\\u")) {
      ...
      if (__qin_binary__("!=", decoded, null)) {
        return com_slime_parser_base_SlimeJavascriptParserBase.__qin_field_RESERVED_WORDS.contains(decoded);
      }
      return false;
    })()) {
        this.setParseFail();
