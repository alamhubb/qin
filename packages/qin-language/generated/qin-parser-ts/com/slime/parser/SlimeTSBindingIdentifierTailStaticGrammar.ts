...
class com_slime_parser_SlimeTSBindingIdentifierTailStaticGrammar {
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 0 && true) {
      this.__qin_constructor_com_slime_parser_SlimeTSBindingIdentifierTailStaticGrammar_0_0();
      return;
    }
    throw new Error("Unsupported Java constructor overload: SlimeTSBindingIdentifierTailStaticGrammar/" + __qin_args.length);
  }
...
const SlimeTSBindingIdentifierTailStaticGrammar = com_slime_parser_SlimeTSBindingIdentifierTailStaticGrammar;
...
export { com_slime_parser_SlimeTSBindingIdentifierTailStaticGrammar };
