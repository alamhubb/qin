...
class com_slime_parser_statements_SlimeStatementIfStaticGrammar {
  static __qin_field_ACTION_CONDITION_EXPRESSION: string | null = null as any;
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 0 && true) {
      this.__qin_constructor_com_slime_parser_statements_SlimeStatementIfStaticGrammar_0_0();
      return;
    }
    throw new Error("Unsupported Java constructor overload: SlimeStatementIfStaticGrammar/" + __qin_args.length);
  }
...
com_slime_parser_statements_SlimeStatementIfStaticGrammar.__qin_field_ACTION_CONDITION_EXPRESSION = "SlimeStatementIf.conditionExpression";
...
export { com_slime_parser_statements_SlimeStatementIfStaticGrammar };
