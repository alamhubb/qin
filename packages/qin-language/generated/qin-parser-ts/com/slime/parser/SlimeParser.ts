...
class com_slime_parser_SlimeParser extends com_slime_parser_typescript_SlimeTSDeclarationParser {
  ...
  __qin_subhuti_raw_TSAccessibilityModifier(): any {
    this.Or(__qin_java_functional(() => {
      return this.consumeClassContextualModifier("public");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("private");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("protected");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("readonly");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("override");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("declare");
    }), __qin_java_functional(() => {
      return this.consumeClassContextualModifier("accessor");
    }));
    return null;
  }
  consumeClassContextualModifier(value: string): any {
    if ((() => {
      if ((() => {
      if (this.matchIdentifierValue(value)) {
        return __qin_binary__("!=", this.LA(2.0), null);
      }
      return false;
    })()) {
        return __QinJavaLangString.equals("LParen", this.LA(2.0).getTokenName());
      }
      return false;
    })()) {
      this.setParseFail();
    ...
    this.consumeIdentifierValue(value);
    return null;
  }
