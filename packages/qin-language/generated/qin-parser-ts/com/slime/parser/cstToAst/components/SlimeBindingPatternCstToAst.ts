...
class com_slime_parser_cstToAst_components_SlimeBindingPatternCstToAst {
  ...
  static firstIdentifier(pattern: any): any {
    let identifier: any = null;
    let assignmentPattern: any = null;
    if ((() => { const __qin_pattern_value = pattern; return __qin_pattern_value instanceof Identifier && (identifier = __qin_pattern_value, true); })()) {
      return identifier;
    }
    if ((() => { const __qin_pattern_value = pattern; return __qin_pattern_value instanceof AssignmentPattern && (assignmentPattern = __qin_pattern_value, true); })()) {
