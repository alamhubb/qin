...
import { __qin_builtin_constructor__, __qin_java_pattern_regexp__, __QinJavaLangString, __qin_java_class_info__, __qin_binary__, __qin_instanceof__, __qin_logical__, __qin_java_implements, __QinJavaUtilObjects, __QinJavaUtilArrayList, __QinJavaUtilUnmodifiableList, __QinJavaUtilList, __QinJavaUtilArrays, __QinJavaUtilRegexPattern, __QinJavaLangNumber } from "@qin/java-sdk-js";
...
class com_slime_parser_cstToAst_SlimeAstCreateUtils {
  ...
  static createSyntaxToken(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createSyntaxToken_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static enrichSourceLocation(location: com_slime_ast_SourceLocation, defaultType: string, defaultValue: string): any {
    ...
    let resolvedType: any = (__qin_binary__("!=", location.type(), null) ? location.type() : defaultType);
    let resolvedValue: any = (__qin_binary__("!=", location.value(), null) ? location.value() : defaultValue);
  ...
  static resolveSubhutiLocation(cst: com_subhuti_struct_SubhutiCst): any {
    ...
    if ((__qin_binary__("!=", direct, null) && __qin_binary__("!=", direct.start(), null) && __qin_binary__("!=", direct.end(), null))) {
      let resolvedType: any = (__qin_binary__("!=", direct.getType(), null) ? direct.getType() : cst.getName());
      let resolvedValue: any = (__qin_binary__("!=", direct.getValue(), null) ? direct.getValue() : cst.getValue());
  ...
  static findLastDescendantLocation(cst: com_subhuti_struct_SubhutiCst): any {
    ...
    if (__qin_binary__("!=", cst.getChildren(), null)) {
      for (let i: any = __qin_binary__("-", ((__qin_collection) => __qin_collection == null ? 0 : (Array.isArray(__qin_collection) ? __qin_collection.length : __qin_collection.size()))(cst.getChildren()), 1.0); __qin_binary__(">=", i, 0.0); i--) {
        let found: any = com_slime_parser_cstToAst_SlimeAstCreateUtils.findLastDescendantLocation(((__qin_collection, __qin_index) => Array.isArray(__qin_collection) ? __qin_collection[Number(__qin_index)] : __qin_collection.get(__qin_index))(cst.getChildren(), i));
        if (__qin_binary__("!=", found, null)) {
          return found;
        }
      }
  ...
  static toPattern(expr: com_slime_ast_Expression, location: com_slime_ast_SourceLocation): any {
    ...
    if ((() => { const __qin_pattern_value = expr; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_expressions_ParenthesizedExpression) && (parenthesizedExpression = __qin_pattern_value, true); })()) {
    ...
    if ((() => { const __qin_pattern_value = expr; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_misc_SpreadElement) && (spreadElement = __qin_pattern_value, true); })()) {
    ...
    if ((() => { const __qin_pattern_value = expr; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_expressions_ArrayExpression) && (arrayExpression = __qin_pattern_value, true); })()) {
    ...
    if ((() => { const __qin_pattern_value = expr; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_expressions_ObjectExpression) && (objectExpression = __qin_pattern_value, true); })()) {
      let properties: any = new __QinJavaUtilArrayList();
      for (const property of objectExpression.properties()) {
        if ((() => { const __qin_pattern_value = property; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_misc_Property) && (objectProperty = __qin_pattern_value, true); })()) {
          properties.add(objectProperty);
        } else {
          if ((() => { const __qin_pattern_value = property; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_misc_SpreadElement) && (spreadElement = __qin_pattern_value, true); })()) {
  ...
  static createClassDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && true && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SourceLocation) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createClassDeclaration_5_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_java_implements(__qin_args[3], "com.slime.ast.AstNode")) && (__qin_args[4] === null || Array.isArray(__qin_args[4]) || __qin_args[4] instanceof __QinJavaUtilArrayList || __qin_args[4] instanceof __QinJavaUtilUnmodifiableList) && true && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SourceLocation) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createClassDeclaration_7_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], (Array.isArray(__qin_args[4]) ? new __QinJavaUtilArrayList(__qin_args[4]) : __qin_args[4]), __qin_args[5], __qin_args[6]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || Array.isArray(__qin_args[3]) || __qin_args[3] instanceof __QinJavaUtilArrayList || __qin_args[3] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[4] === null || __qin_java_implements(__qin_args[4], "com.slime.ast.AstNode")) && (__qin_args[5] === null || Array.isArray(__qin_args[5]) || __qin_args[5] instanceof __QinJavaUtilArrayList || __qin_args[5] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SourceLocation) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createClassDeclaration_7_2(__qin_args[0], __qin_args[1], __qin_args[2], (Array.isArray(__qin_args[3]) ? new __QinJavaUtilArrayList(__qin_args[3]) : __qin_args[3]), __qin_args[4], (Array.isArray(__qin_args[5]) ? new __QinJavaUtilArrayList(__qin_args[5]) : __qin_args[5]), __qin_args[6]);
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && true && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassDeclaration_5_3(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_java_implements(__qin_args[3], "com.slime.ast.AstNode")) && (__qin_args[4] === null || Array.isArray(__qin_args[4]) || __qin_args[4] instanceof __QinJavaUtilArrayList || __qin_args[4] instanceof __QinJavaUtilUnmodifiableList) && true && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassDeclaration_7_4(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], (Array.isArray(__qin_args[4]) ? new __QinJavaUtilArrayList(__qin_args[4]) : __qin_args[4]), __qin_args[5], __qin_args[6]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || Array.isArray(__qin_args[3]) || __qin_args[3] instanceof __QinJavaUtilArrayList || __qin_args[3] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[4] === null || __qin_java_implements(__qin_args[4], "com.slime.ast.AstNode")) && (__qin_args[5] === null || Array.isArray(__qin_args[5]) || __qin_args[5] instanceof __QinJavaUtilArrayList || __qin_args[5] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassDeclaration_7_5(__qin_args[0], __qin_args[1], __qin_args[2], (Array.isArray(__qin_args[3]) ? new __QinJavaUtilArrayList(__qin_args[3]) : __qin_args[3]), __qin_args[4], (Array.isArray(__qin_args[5]) ? new __QinJavaUtilArrayList(__qin_args[5]) : __qin_args[5]), __qin_args[6]);
  ...
  static createFunctionDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 6 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && true && (__qin_args[2] === null || typeof __qin_args[2] !== "undefined") && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SourceLocation) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createFunctionDeclaration_6_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5]);
    if (__qin_args.length === 9 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || Array.isArray(__qin_args[1]) || __qin_args[1] instanceof __QinJavaUtilArrayList || __qin_args[1] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[2] === null || Array.isArray(__qin_args[2]) || __qin_args[2] instanceof __QinJavaUtilArrayList || __qin_args[2] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && typeof __qin_args[4] === "boolean" && typeof __qin_args[5] === "boolean" && (__qin_args[6] === null || __qin_java_implements(__qin_args[6], "com.slime.ast.AstNode")) && (__qin_args[7] === null || __qin_java_implements(__qin_args[7], "com.slime.ast.AstNode")) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_slime_ast_SourceLocation) || __qin_args[8].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createFunctionDeclaration_9_1(__qin_args[0], (Array.isArray(__qin_args[1]) ? new __QinJavaUtilArrayList(__qin_args[1]) : __qin_args[1]), (Array.isArray(__qin_args[2]) ? new __QinJavaUtilArrayList(__qin_args[2]) : __qin_args[2]), __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
    if (__qin_args.length === 6 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createFunctionDeclaration_6_2(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5]);
    if (__qin_args.length === 9 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && true && (__qin_args[2] === null || Array.isArray(__qin_args[2]) || __qin_args[2] instanceof __QinJavaUtilArrayList || __qin_args[2] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && typeof __qin_args[4] === "boolean" && typeof __qin_args[5] === "boolean" && (__qin_args[6] === null || __qin_java_implements(__qin_args[6], "com.slime.ast.AstNode")) && (__qin_args[7] === null || __qin_java_implements(__qin_args[7], "com.slime.ast.AstNode")) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createFunctionDeclaration_9_3(__qin_args[0], __qin_args[1], (Array.isArray(__qin_args[2]) ? new __QinJavaUtilArrayList(__qin_args[2]) : __qin_args[2]), __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
  ...
  static __qin_overload_createFunctionDeclaration_6_0(id: com_slime_ast_nodes_expressions_Identifier, params: any[], body: any, generator: boolean, async: boolean, location: com_slime_ast_SourceLocation): any {
    return com_slime_parser_cstToAst_SlimeAstCreateUtils.createFunctionDeclaration(id, com_slime_parser_cstToAst_SlimeAstCreateUtils.filterList(params, __qin_java_class_info__(null, { name: "com.slime.ast.Pattern", interfaceName: "com.slime.ast.Pattern" })), __QinJavaUtilList.of(), ((() => { const __qin_instanceof_value = body; return __qin_instanceof__(__qin_instanceof_value, com_slime_ast_nodes_statements_BlockStatement); })() ? (body) : null), generator, async, null, null, location);
  }
  ...
  static __qin_overload_createFunctionDeclaration_9_3(id: com_slime_ast_nodes_expressions_Identifier, params: com_slime_ast_Pattern[], parameterMetadata: any, body: com_slime_ast_nodes_statements_BlockStatement, generator: boolean, async: boolean, returnType: com_slime_ast_AstNode, typeParameters: com_slime_ast_AstNode, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_declarations_FunctionDeclaration(id, (__qin_binary__("==", params, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(params)), (__qin_binary__("==", parameterMetadata, null) ? __QinJavaUtilList.of() : parameterMetadata), body, generator, async, returnType, typeParameters, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createVariableDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && true && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createVariableDeclaration_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static __qin_overload_createVariableDeclaration_3_1(declarations: com_slime_ast_nodes_misc_VariableDeclarator[], kind: string, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_declarations_VariableDeclaration(kind, (__qin_binary__("==", declarations, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(declarations)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createVariableDeclarator(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Pattern")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createVariableDeclarator_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createVariableDeclarator_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Pattern")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createVariableDeclarator_3_2(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createVariableDeclarator_3_3(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createBlockStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createBlockStatement_2_0(__qin_args[0], __qin_args[1]);
  ...
  static __qin_overload_createBlockStatement_2_0(body: com_slime_ast_Statement[], location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_statements_BlockStatement((__qin_binary__("==", body, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(body)), location);
  }
  static __qin_overload_createBlockStatement_2_1(body: com_slime_ast_Statement[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_statements_BlockStatement((__qin_binary__("==", body, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(body)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createExpressionStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExpressionStatement_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createIfStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Statement")) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Statement")) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createIfStatement_4_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
  ...
  static createWhileStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Statement")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createWhileStatement_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createDoWhileStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Statement")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createDoWhileStatement_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static __qin_overload_createForStatement_5_0(init: any, test: com_slime_ast_Expression, update: com_slime_ast_Expression, body: com_slime_ast_Statement, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_statements_ForStatement(((() => { const __qin_instanceof_value = init; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (init) : null), test, update, body, location);
  }
  ...
  static __qin_overload_createForInStatement_4_0(left: any, right: com_slime_ast_Expression, body: com_slime_ast_Statement, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_statements_ForInStatement(((() => { const __qin_instanceof_value = left; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (left) : null), right, body, location);
  }
  ...
  static createForOfStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 5 && (__qin_args[0] === null || typeof __qin_args[0] !== "undefined") && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Statement")) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SourceLocation) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createForOfStatement_5_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
  ...
  static __qin_overload_createForOfStatement_5_0(left: any, right: com_slime_ast_Expression, body: com_slime_ast_Statement, __qin_await: boolean, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_statements_ForOfStatement(((() => { const __qin_instanceof_value = left; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (left) : null), right, body, __qin_await, location);
  }
  ...
  static createReturnStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createReturnStatement_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createBreakStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createBreakStatement_2_0(__qin_args[0], __qin_args[1]);
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createBreakStatement_2_1(__qin_args[0], __qin_args[1]);
  ...
  static createContinueStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createContinueStatement_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createThrowStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createThrowStatement_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createTryStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_misc_CatchClause) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_misc_CatchClause.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createTryStatement_4_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_misc_CatchClause) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_misc_CatchClause.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createTryStatement_4_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
  ...
  static createCatchClause(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Pattern")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createCatchClause_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Pattern")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createCatchClause_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createSwitchStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createSwitchStatement_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static __qin_overload_createSwitchStatement_3_0(discriminant: com_slime_ast_Expression, cases: com_slime_ast_nodes_misc_SwitchCase[], location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_statements_SwitchStatement(discriminant, (__qin_binary__("==", cases, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(cases)), location);
  }
  static __qin_overload_createSwitchStatement_3_1(discriminant: com_slime_ast_Expression, cases: com_slime_ast_nodes_misc_SwitchCase[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_statements_SwitchStatement(discriminant, (__qin_binary__("==", cases, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(cases)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createSwitchCase(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createSwitchCase_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static __qin_overload_createSwitchCase_3_0(test: com_slime_ast_Expression, consequent: com_slime_ast_Statement[], location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_misc_SwitchCase(test, (__qin_binary__("==", consequent, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(consequent)), location);
  }
  static __qin_overload_createSwitchCase_3_1(test: com_slime_ast_Expression, consequent: com_slime_ast_Statement[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_misc_SwitchCase(test, (__qin_binary__("==", consequent, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(consequent)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createLabeledStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Statement")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createLabeledStatement_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createWithStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Statement")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createWithStatement_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createDebuggerStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 1 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_SourceLocation) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createDebuggerStatement_1_0(__qin_args[0]);
  ...
  static createEmptyStatement(...__qin_args: any[]): any {
    if (__qin_args.length === 1 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_SourceLocation) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createEmptyStatement_1_0(__qin_args[0]);
  ...
  static createIdentifier(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createIdentifier_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createStringLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass) && (__qin_args[2] === null || typeof __qin_args[2] === "string")) return this.__qin_overload_createStringLiteral_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createRegexLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createRegexLiteral_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createBooleanLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && typeof __qin_args[0] === "boolean" && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createBooleanLiteral_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createNumericLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "number") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createNumericLiteral_2_0(__qin_args[0], __qin_args[1]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || typeof __qin_args[0] === "number") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createNumericLiteral_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createNullLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 1 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_SourceLocation) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createNullLiteral_1_0(__qin_args[0]);
  ...
  static createTemplateLiteral(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && true && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createTemplateLiteral_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createTemplateElement(...__qin_args: any[]): any {
    if (__qin_args.length === 4 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createTemplateElement_4_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
  ...
  static createTaggedTemplateExpression(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_TemplateLiteral) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_TemplateLiteral.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createTaggedTemplateExpression_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_TemplateLiteral) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_TemplateLiteral.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createTaggedTemplateExpression_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createProperty(...__qin_args: any[]): any {
    ...
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || typeof __qin_args[2] === "string") && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && typeof __qin_args[5] === "boolean" && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SourceLocation) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createProperty_7_2(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6]);
  ...
  static createImportDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createImportDeclaration_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 4 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createImportDeclaration_4_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
    if (__qin_args.length === 8 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SyntaxToken) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SourceLocation) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createImportDeclaration_8_2(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7]);
    if (__qin_args.length === 9 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_slime_ast_SourceLocation) || __qin_args[8].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createImportDeclaration_9_3(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
    if (__qin_args.length === 3 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createImportDeclaration_3_4(__qin_args[0], __qin_args[1], __qin_args[2]);
    if (__qin_args.length === 4 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createImportDeclaration_4_5(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
    if (__qin_args.length === 8 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SyntaxToken) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createImportDeclaration_8_6(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7]);
    if (__qin_args.length === 9 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_nodes_expressions_Literal) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createImportDeclaration_9_7(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
  ...
  static createExportNamedDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportNamedDeclaration_4_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SourceLocation) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportNamedDeclaration_5_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    if (__qin_args.length === 9 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_slime_ast_SourceLocation) || __qin_args[8].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportNamedDeclaration_9_2(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
    if (__qin_args.length === 10 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_slime_ast_SyntaxToken) || __qin_args[8].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[9] === null || __qin_instanceof__(__qin_args[9], com_slime_ast_SourceLocation) || __qin_args[9].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportNamedDeclaration_10_3(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8], __qin_args[9]);
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createExportNamedDeclaration_4_4(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createExportNamedDeclaration_5_5(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    if (__qin_args.length === 9 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createExportNamedDeclaration_9_6(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8]);
    if (__qin_args.length === 10 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Declaration")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_Literal) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Literal.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SyntaxToken) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_slime_ast_SyntaxToken) || __qin_args[5].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_slime_ast_SyntaxToken) || __qin_args[6].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_slime_ast_SyntaxToken) || __qin_args[7].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_slime_ast_SyntaxToken) || __qin_args[8].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[9] === null || __qin_instanceof__(__qin_args[9], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createExportNamedDeclaration_10_7(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8], __qin_args[9]);
  ...
  static createExportDefaultDeclaration(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] !== "undefined") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportDefaultDeclaration_2_0(__qin_args[0], __qin_args[1]);
    if (__qin_args.length === 5 && (__qin_args[0] === null || typeof __qin_args[0] !== "undefined") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SyntaxToken) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SyntaxToken) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_slime_ast_SourceLocation) || __qin_args[4].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createExportDefaultDeclaration_5_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    ...
    if (__qin_args.length === 5 && (__qin_args[0] === null || typeof __qin_args[0] !== "undefined") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SyntaxToken) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SyntaxToken) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SyntaxToken) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createExportDefaultDeclaration_5_3(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
  ...
  static __qin_overload_createExportDefaultDeclaration_2_0(declaration: any, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_modules_ExportDefaultDeclaration(((() => { const __qin_instanceof_value = declaration; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (declaration) : null), location);
  }
  static __qin_overload_createExportDefaultDeclaration_5_1(declaration: any, exportToken: com_slime_ast_SyntaxToken, defaultToken: com_slime_ast_SyntaxToken, semicolonToken: com_slime_ast_SyntaxToken, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_modules_ExportDefaultDeclaration(((() => { const __qin_instanceof_value = declaration; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (declaration) : null), exportToken, defaultToken, location, semicolonToken);
  }
  ...
  static createProgram(...__qin_args: any[]): any {
    if (__qin_args.length === 3 && true && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createProgram_3_0(__qin_args[0], __qin_args[1], __qin_args[2]);
  ...
  static createClassBody(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createClassBody_2_0(__qin_args[0], __qin_args[1]);
  ...
  static createArrayExpression(...__qin_args: any[]): any {
    if (__qin_args.length === 1 && true) return this.__qin_overload_createArrayExpression_1_0(__qin_args[0]);
    if (__qin_args.length === 2 && true && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SourceLocation) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createArrayExpression_2_1(__qin_args[0], __qin_args[1]);
  ...
  static __qin_overload_createArrayExpression_1_0(elements: com_slime_ast_Expression[]): any {
    return com_slime_parser_cstToAst_SlimeAstCreateUtils.createArrayExpression(elements, (null));
  }
  static __qin_overload_createArrayExpression_2_1(elements: com_slime_ast_Expression[], location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_expressions_ArrayExpression((__qin_binary__("==", elements, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(elements)), location);
  }
  static __qin_overload_createArrayExpression_2_2(elements: com_slime_ast_Expression[], location: com_subhuti_struct_SubhutiSourceLocation): any {
  ...
  static __qin_overload_createObjectExpression_2_0(properties: com_slime_ast_AstNode[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_ObjectExpression((__qin_binary__("==", properties, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(properties)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  ...
  static createAssignmentExpression(operator: string, left: com_slime_ast_Expression, right: com_slime_ast_Expression, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_AssignmentExpression(operator, ((() => { const __qin_instanceof_value = left; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (left) : com_slime_parser_cstToAst_SlimeAstCreateUtils.toPattern(left, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location))), right, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  ...
  static createSequenceExpression(expressions: com_slime_ast_Expression[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_SequenceExpression((__qin_binary__("==", expressions, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(expressions)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  ...
  static createCallExpression(...__qin_args: any[]): any {
    ...
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_SourceLocation) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createCallExpression_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
    ...
    if (__qin_args.length === 4 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && true && typeof __qin_args[2] === "boolean" && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_slime_ast_SourceLocation) || __qin_args[3].__qinJavaRecordClass === com_slime_ast_SourceLocation.__qinJavaRecordClass)) return this.__qin_overload_createCallExpression_4_3(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3]);
  ...
  static __qin_overload_createCallExpression_2_0(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[]): any {
    return com_slime_parser_cstToAst_SlimeAstCreateUtils.createCallExpression(callee, __qin_arguments, false, (null));
  }
  static __qin_overload_createCallExpression_3_1(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[], location: com_slime_ast_SourceLocation): any {
    return com_slime_parser_cstToAst_SlimeAstCreateUtils.createCallExpression(callee, __qin_arguments, false, location);
  }
  static __qin_overload_createCallExpression_3_2(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[], location: com_subhuti_struct_SubhutiSourceLocation): any {
  ...
  static __qin_overload_createCallExpression_4_3(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[], optional: boolean, location: com_slime_ast_SourceLocation): any {
    return new com_slime_ast_nodes_expressions_CallExpression(callee, (__qin_binary__("==", __qin_arguments, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(__qin_arguments)), optional, location);
  }
  static __qin_overload_createCallExpression_4_4(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[], optional: boolean, location: com_subhuti_struct_SubhutiSourceLocation): any {
  ...
  static __qin_overload_createNewExpression_4_1(callee: com_slime_ast_Expression, __qin_arguments: com_slime_ast_Expression[], hasArguments: boolean, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_NewExpression(callee, (__qin_binary__("==", __qin_arguments, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(__qin_arguments)), hasArguments, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createMemberExpression(...__qin_args: any[]): any {
    ...
    if (__qin_args.length === 3 && (__qin_args[0] === null || __qin_java_implements(__qin_args[0], "com.slime.ast.Expression")) && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_slime_ast_SyntaxToken) || __qin_args[1].__qinJavaRecordClass === com_slime_ast_SyntaxToken.__qinJavaRecordClass) && (__qin_args[2] === null || __qin_java_implements(__qin_args[2], "com.slime.ast.Expression"))) return this.__qin_overload_createMemberExpression_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
    throw new Error("Unsupported Java overload: createMemberExpression/" + __qin_args.length);
  }
  static __qin_overload_createMemberExpression_5_0(object: com_slime_ast_Expression, property: com_slime_ast_Expression, computed: boolean, optional: boolean, location: com_subhuti_struct_SubhutiSourceLocation): any {
  ...
  static __qin_overload_createMemberExpression_3_1(object: com_slime_ast_Expression, dot: com_slime_ast_SyntaxToken, property: com_slime_ast_Expression): any {
  ...
  static createArrayPattern(elements: com_slime_ast_Pattern[], location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_patterns_ArrayPattern((__qin_binary__("==", elements, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(elements)), com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  ...
  static createFunctionExpression(...__qin_args: any[]): any {
    if (__qin_args.length === 6 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && true && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_statements_BlockStatement) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_statements_BlockStatement.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createFunctionExpression_6_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5]);
  ...
  static __qin_overload_createFunctionExpression_9_1(id: com_slime_ast_nodes_expressions_Identifier, params: com_slime_ast_Pattern[], parameterMetadata: any, body: com_slime_ast_nodes_statements_BlockStatement, generator: boolean, async: boolean, returnType: com_slime_ast_AstNode, typeParameters: com_slime_ast_AstNode, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_FunctionExpression(id, (__qin_binary__("==", params, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(params)), (__qin_binary__("==", parameterMetadata, null) ? __QinJavaUtilList.of() : parameterMetadata), body, generator, async, returnType, typeParameters, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  ...
  static createClassExpression(...__qin_args: any[]): any {
    if (__qin_args.length === 5 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && true && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassExpression_5_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || __qin_java_implements(__qin_args[3], "com.slime.ast.AstNode")) && (__qin_args[4] === null || Array.isArray(__qin_args[4]) || __qin_args[4] instanceof __QinJavaUtilArrayList || __qin_args[4] instanceof __QinJavaUtilUnmodifiableList) && true && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassExpression_7_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], (Array.isArray(__qin_args[4]) ? new __QinJavaUtilArrayList(__qin_args[4]) : __qin_args[4]), __qin_args[5], __qin_args[6]);
    if (__qin_args.length === 7 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_slime_ast_nodes_expressions_Identifier) || __qin_args[0].__qinJavaRecordClass === com_slime_ast_nodes_expressions_Identifier.__qinJavaRecordClass) && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_misc_ClassBody) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_misc_ClassBody.__qinJavaRecordClass) && (__qin_args[3] === null || Array.isArray(__qin_args[3]) || __qin_args[3] instanceof __QinJavaUtilArrayList || __qin_args[3] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[4] === null || __qin_java_implements(__qin_args[4], "com.slime.ast.AstNode")) && (__qin_args[5] === null || Array.isArray(__qin_args[5]) || __qin_args[5] instanceof __QinJavaUtilArrayList || __qin_args[5] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[6] === null || __qin_instanceof__(__qin_args[6], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createClassExpression_7_2(__qin_args[0], __qin_args[1], __qin_args[2], (Array.isArray(__qin_args[3]) ? new __QinJavaUtilArrayList(__qin_args[3]) : __qin_args[3]), __qin_args[4], (Array.isArray(__qin_args[5]) ? new __QinJavaUtilArrayList(__qin_args[5]) : __qin_args[5]), __qin_args[6]);
  ...
  static createMethodDefinition(...__qin_args: any[]): any {
    if (__qin_args.length === 6 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] !== "undefined") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_FunctionExpression) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_FunctionExpression.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || __qin_instanceof__(__qin_args[5], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createMethodDefinition_6_0(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5]);
    if (__qin_args.length === 8 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] !== "undefined") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_FunctionExpression) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_FunctionExpression.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || typeof __qin_args[5] === "string") && typeof __qin_args[6] === "boolean" && (__qin_args[7] === null || __qin_instanceof__(__qin_args[7], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createMethodDefinition_8_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], __qin_args[5], __qin_args[6], __qin_args[7]);
    if (__qin_args.length === 9 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] !== "undefined") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_slime_ast_nodes_expressions_FunctionExpression) || __qin_args[2].__qinJavaRecordClass === com_slime_ast_nodes_expressions_FunctionExpression.__qinJavaRecordClass) && typeof __qin_args[3] === "boolean" && typeof __qin_args[4] === "boolean" && (__qin_args[5] === null || Array.isArray(__qin_args[5]) || __qin_args[5] instanceof __QinJavaUtilArrayList || __qin_args[5] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[6] === null || typeof __qin_args[6] === "string") && typeof __qin_args[7] === "boolean" && (__qin_args[8] === null || __qin_instanceof__(__qin_args[8], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createMethodDefinition_9_2(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], __qin_args[4], (Array.isArray(__qin_args[5]) ? new __QinJavaUtilArrayList(__qin_args[5]) : __qin_args[5]), __qin_args[6], __qin_args[7], __qin_args[8]);
  ...
  static __qin_overload_createMethodDefinition_9_2(kind: string, key: any, value: com_slime_ast_nodes_expressions_FunctionExpression, computed: boolean, isStatic: boolean, decorators: any, accessibility: string, override: boolean, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_misc_MethodDefinition(((() => { const __qin_instanceof_value = key; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (key) : null), value, kind, computed, isStatic, (__qin_binary__("==", decorators, null) ? __QinJavaUtilList.of() : decorators), accessibility, override, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
  static createPropertyDefinition(...__qin_args: any[]): any {
    ...
    if (__qin_args.length === 11 && (__qin_args[0] === null || typeof __qin_args[0] !== "undefined") && (__qin_args[1] === null || __qin_java_implements(__qin_args[1], "com.slime.ast.Expression")) && typeof __qin_args[2] === "boolean" && typeof __qin_args[3] === "boolean" && (__qin_args[4] === null || Array.isArray(__qin_args[4]) || __qin_args[4] instanceof __QinJavaUtilArrayList || __qin_args[4] instanceof __QinJavaUtilUnmodifiableList) && (__qin_args[5] === null || __qin_java_implements(__qin_args[5], "com.slime.ast.AstNode")) && typeof __qin_args[6] === "boolean" && (__qin_args[7] === null || typeof __qin_args[7] === "string") && typeof __qin_args[8] === "boolean" && typeof __qin_args[9] === "boolean" && (__qin_args[10] === null || __qin_instanceof__(__qin_args[10], com_subhuti_struct_SubhutiSourceLocation))) return this.__qin_overload_createPropertyDefinition_11_1(__qin_args[0], __qin_args[1], __qin_args[2], __qin_args[3], (Array.isArray(__qin_args[4]) ? new __QinJavaUtilArrayList(__qin_args[4]) : __qin_args[4]), __qin_args[5], __qin_args[6], __qin_args[7], __qin_args[8], __qin_args[9], __qin_args[10]);
  ...
  static __qin_overload_createArrowFunctionExpression_6_1(params: com_slime_ast_Pattern[], body: any, expression: boolean, async: boolean, paramsParenthesized: boolean, location: com_subhuti_struct_SubhutiSourceLocation): any {
    return new com_slime_ast_nodes_expressions_ArrowFunctionExpression((__qin_binary__("==", params, null) ? __QinJavaUtilList.of() : __QinJavaUtilArrays.asList(params)), ((() => { const __qin_instanceof_value = body; return __qin_java_implements(__qin_instanceof_value, "com.slime.ast.AstNode"); })() ? (body) : null), async, expression, paramsParenthesized, com_slime_parser_cstToAst_SlimeAstCreateUtils.toSourceLocation(location));
  }
}
