...
class com_slime_parser_cstToAst_SlimeCstToAstUtils {
  ...
  createLexicalBindingAst(cst: com_subhuti_struct_SubhutiCst): any {
    ...
    if ((() => {
      if ((() => {
      if ((() => { const __qin_pattern_value = declaration; return __qin_pattern_value instanceof com_slime_ast_nodes_declarations_VariableDeclaration && (variableDeclaration = __qin_pattern_value, true); })()) {
        return __qin_binary__("!=", variableDeclaration.declarations(), null);
      }
      return false;
    })()) {
        return (() => {
      if (__QinJavaLangString.isEmpty(variableDeclaration.declarations())) {
        return false;
      }
      return true;
    })();
