...
class com_slime_parser_cstToAst_SlimeCstToAstUtils {
  ...
  createLexicalBindingAst(cst: com_subhuti_struct_SubhutiCst): any {
    ...
    if (((() => { const __qin_pattern_value = declaration; return __qin_instanceof__(__qin_pattern_value, com_slime_ast_nodes_declarations_VariableDeclaration) && (variableDeclaration = __qin_pattern_value, true); })() && __qin_binary__("!=", variableDeclaration.declarations(), null) && !variableDeclaration.declarations().isEmpty())) {
