...
import { __qin_builtin_constructor__, __qin_java_pattern_regexp__, __QinJavaLangString, __qin_java_class_info__, __qin_binary__, __qin_instanceof__, __qin_logical__, __qin_collection_get__ } from "@qin/java-sdk-js";
...
class com_slime_parser_cstToAst_SlimeCstToAstUtils {
  ...
  toProgram(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_misc_Program {
    {
      const __qin_typed_receiver_2085: com_slime_parser_cstToAst_SlimeCstToAstUtils = this;
      __qin_typed_receiver_2085.resetState();
    }
    return this.__qin_field_programCstToAst.createProgramAst(cst);
  }
  createIdentifierAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_Identifier {
    return com_slime_parser_cstToAst_identifier_SlimeIdentifierCstToAst.createIdentifierAst(cst);
  }
  createBindingIdentifierAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_Identifier {
    return com_slime_parser_cstToAst_identifier_SlimeIdentifierCstToAst.createBindingIdentifierAst(cst);
  }
  createBooleanLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_Literal {
    return com_slime_parser_cstToAst_literal_SlimeLiteralCstToAst.createBooleanLiteralAst(cst);
  }
  createNumericLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_Literal {
    return com_slime_parser_cstToAst_literal_SlimeLiteralCstToAst.createNumericLiteralAst(cst);
  }
  createStringLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_Literal {
  ...
  createBinaryExpressionAst(left: com_slime_ast_Expression, op: string, right: com_slime_ast_Expression, cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
    return com_slime_parser_cstToAst_expressions_SlimeBinaryExpressionCstToAst.createBinaryExpressionAst(left, op, right, cst);
  }
  createUnaryExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
    return this.__qin_field_unaryExpressionCstToAst.createUnaryExpressionAst(cst);
  }
  createUpdateExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
  ...
  createNewExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
    return this.__qin_field_newExpressionCstToAst.createNewExpressionAst(cst);
  }
  createOptionalExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
    return this.__qin_field_optionalExpressionCstToAst.createOptionalExpressionAst(cst);
  }
  createOptionalChainAst(object: com_slime_ast_Expression, chainCst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
  ...
  createExpressionAstUncached(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Expression {
    return this.__qin_field_expressionCstToAst.createExpressionAst(cst);
  }
  createTemplateLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_TemplateLiteral {
  ...
  createLexicalBindingAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_misc_VariableDeclarator {
    let variableDeclaration: com_slime_ast_nodes_declarations_VariableDeclaration = null as any;
    let declaration: any = this.__qin_field_variableCstToAst.createVariableDeclarationAst(cst);
    if (((__qin_instanceof__(declaration, com_slime_ast_nodes_declarations_VariableDeclaration) && (variableDeclaration = declaration, true)) && __qin_binary__("!=", variableDeclaration.declarations(), null) && !variableDeclaration.declarations().isEmpty())) {
      const __qin_pattern_variableDeclaration = variableDeclaration;
      let variableDeclaration: com_slime_ast_nodes_declarations_VariableDeclaration = __qin_pattern_variableDeclaration as any;
      return __qin_collection_get__(variableDeclaration.declarations(), 0.0);
    }
  ...
  createBindingTargetAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Pattern {
  ...
  createForStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_statements_ForStatement {
    return this.__qin_field_loopCstToAst.createForStatementAst(cst);
  }
  createForInStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Statement {
    return this.__qin_field_loopCstToAst.createForInStatementAst(cst);
  }
  createForOfStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Statement {
    return this.__qin_field_loopCstToAst.createForOfStatementAst(cst);
  }
  createForInOfStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Statement {
    return this.__qin_field_loopCstToAst.createForInOfStatementAst(cst);
  }
  createWhileStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_statements_WhileStatement {
    return this.__qin_field_loopCstToAst.createWhileStatementAst(cst);
  }
  createDoWhileStatementAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_statements_DoWhileStatement {
  ...
  createFunctionBodyAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_statements_BlockStatement {
    return this.__qin_field_functionBodyCstToAst.createFunctionBodyAst(cst);
  }
  createFunctionBodyAstBase(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_statements_BlockStatement {
    return this.__qin_field_functionBodyCstToAst.createFunctionBodyAst(cst);
  }
  createFormalParametersAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_Pattern[] {
    return this.__qin_field_functionParameterCstToAst.createFormalParameters(cst);
  }
  createFormalParameterMetadataAst(cst: com_subhuti_struct_SubhutiCst): __QinJavaUtilList<com_slime_ast_nodes_misc_FunctionParameter> {
  ...
  createFunctionExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_FunctionExpression {
    return this.__qin_field_functionExpressionCstToAst.createFunctionExpressionAst(cst);
  }
  createGeneratorExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_FunctionExpression {
    return this.__qin_field_functionExpressionCstToAst.createGeneratorExpressionAst(cst);
  }
  createAsyncFunctionExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_FunctionExpression {
    return this.__qin_field_functionExpressionCstToAst.createAsyncFunctionExpressionAst(cst);
  }
  createAsyncGeneratorExpressionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_FunctionExpression {
    return this.__qin_field_functionExpressionCstToAst.createAsyncGeneratorExpressionAst(cst);
  }
  createArrowFunctionAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_ArrowFunctionExpression {
    return this.__qin_field_arrowFunctionCstToAst.createArrowFunctionAst(cst);
  }
  createObjectLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_ObjectExpression {
    return this.__qin_field_compoundLiteralCstToAst.createObjectLiteral(cst);
  }
  createArrayLiteralAst(cst: com_subhuti_struct_SubhutiCst): com_slime_ast_nodes_expressions_ArrayExpression {
  ...
  createMethodDefinitionAst(cst: com_subhuti_struct_SubhutiCst, isStatic: boolean): com_slime_ast_nodes_misc_MethodDefinition {
