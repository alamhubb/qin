...
class com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar {
  static __qin_field_ACTION_CLOSE_GREATER: string | null = null as any;
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 0 && true) {
      this.__qin_constructor_com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar_0_0();
      return;
    }
    throw new Error("Unsupported Java constructor overload: SlimeTSTypeParameterInstantiationStaticGrammar/" + __qin_args.length);
  }
  __qin_constructor_com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar_0_0(): void {
    null;
  }
  static grammar(): any {
    return com_subhuti_parser_SubhutiStaticGrammar.builder().declareExternalRule("TSType").declareAction(com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar.__qin_field_ACTION_CLOSE_GREATER).rule(com_subhuti_parser_SubhutiStaticGrammar.rule("TSTypeParameterInstantiation", com_subhuti_parser_SubhutiStaticGrammar.seq(com_subhuti_parser_SubhutiStaticGrammar.consume("Less"), com_subhuti_parser_SubhutiStaticGrammar.call("TSType"), com_subhuti_parser_SubhutiStaticGrammar.many(com_subhuti_parser_SubhutiStaticGrammar.seq(com_subhuti_parser_SubhutiStaticGrammar.consume("Comma"), com_subhuti_parser_SubhutiStaticGrammar.call("TSType"))), com_subhuti_parser_SubhutiStaticGrammar.action(com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar.__qin_field_ACTION_CLOSE_GREATER)))).build();
  }
}
const SlimeTSTypeParameterInstantiationStaticGrammar = com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar;
com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar.__qin_field_ACTION_CLOSE_GREATER = "SlimeTSTypeParameterInstantiation.closeGreater";
...
export { com_slime_parser_typescript_SlimeTSTypeParameterInstantiationStaticGrammar };
