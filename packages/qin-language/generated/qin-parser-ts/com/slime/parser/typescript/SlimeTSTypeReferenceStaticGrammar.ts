...
class com_slime_parser_typescript_SlimeTSTypeReferenceStaticGrammar {
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 0 && true) {
      this.__qin_constructor_com_slime_parser_typescript_SlimeTSTypeReferenceStaticGrammar_0_0();
      return;
    }
    throw new Error("Unsupported Java constructor overload: SlimeTSTypeReferenceStaticGrammar/" + __qin_args.length);
  }
...
export { com_slime_parser_typescript_SlimeTSTypeReferenceStaticGrammar };
