...
class com_subhuti_struct_SubhutiSourceLocation {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 7 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || typeof __qin_args[2] === "boolean") && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_subhuti_struct_SubhutiPosition)) && (__qin_args[4] === null || __qin_instanceof__(__qin_args[4], com_subhuti_struct_SubhutiPosition)) && (__qin_args[5] === null || typeof __qin_args[5] === "string") && (__qin_args[6] === null || typeof __qin_args[6] === "string")) {
      ...
      this.__qin_constructor_com_subhuti_struct_SubhutiSourceLocation_7_0(type, value, newLine, start, end, filename, identifierName);
      return;
    }
    if (__qin_args.length === 3 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_instanceof__(__qin_args[1], com_subhuti_struct_SubhutiPosition)) && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiPosition))) {
      const type: any = __qin_args[0];
      const start: any = __qin_args[1];
      const end: any = __qin_args[2];
      this.__qin_constructor_com_subhuti_struct_SubhutiSourceLocation_3_1(type, start, end);
      return;
    }
    if (__qin_args.length === 4 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || __qin_instanceof__(__qin_args[2], com_subhuti_struct_SubhutiPosition)) && (__qin_args[3] === null || __qin_instanceof__(__qin_args[3], com_subhuti_struct_SubhutiPosition))) {
      const type: any = __qin_args[0];
      const value: any = __qin_args[1];
      const start: any = __qin_args[2];
      const end: any = __qin_args[3];
      this.__qin_constructor_com_subhuti_struct_SubhutiSourceLocation_4_2(type, value, start, end);
      return;
    }
