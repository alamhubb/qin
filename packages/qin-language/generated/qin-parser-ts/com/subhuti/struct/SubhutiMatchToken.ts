...
class com_subhuti_struct_SubhutiMatchToken {
  ...
  constructor(...__qin_args: any[]) {
    if (__qin_args.length === 7 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || typeof __qin_args[2] === "number") && (__qin_args[3] === null || typeof __qin_args[3] === "number") && (__qin_args[4] === null || typeof __qin_args[4] === "number") && (__qin_args[5] === null || typeof __qin_args[5] === "number") && (__qin_args[6] === null || typeof __qin_args[6] === "boolean")) {
      ...
      this.__qin_constructor_com_subhuti_struct_SubhutiMatchToken_7_0(tokenName, tokenValue, rowNum, columnStartNum, columnEndNum, index, hasLineBreakBefore);
      return;
    }
    if (__qin_args.length === 8 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string") && typeof __qin_args[2] === "number" && (__qin_args[3] === null || typeof __qin_args[3] === "number") && (__qin_args[4] === null || typeof __qin_args[4] === "number") && (__qin_args[5] === null || typeof __qin_args[5] === "number") && (__qin_args[6] === null || typeof __qin_args[6] === "number") && (__qin_args[7] === null || typeof __qin_args[7] === "boolean")) {
      const tokenName: any = __qin_args[0];
      const tokenValue: any = __qin_args[1];
      const tokenTypeId: any = __qin_args[2];
      const rowNum: any = __qin_args[3];
      const columnStartNum: any = __qin_args[4];
      const columnEndNum: any = __qin_args[5];
      const index: any = __qin_args[6];
      const hasLineBreakBefore: any = __qin_args[7];
      this.__qin_constructor_com_subhuti_struct_SubhutiMatchToken_8_1(tokenName, tokenValue, tokenTypeId, rowNum, columnStartNum, columnEndNum, index, hasLineBreakBefore);
      return;
    }
    if (__qin_args.length === 1 && (__qin_args[0] === null || __qin_instanceof__(__qin_args[0], com_subhuti_struct_SubhutiMatchToken))) {
      const other: any = __qin_args[0];
      this.__qin_constructor_com_subhuti_struct_SubhutiMatchToken_1_2(other);
      return;
    }
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || typeof __qin_args[1] === "string")) {
      const tokenName: any = __qin_args[0];
      const tokenValue: any = __qin_args[1];
      this.__qin_constructor_com_subhuti_struct_SubhutiMatchToken_2_3(tokenName, tokenValue);
      return;
    }
  ...
  __qin_constructor_com_subhuti_struct_SubhutiMatchToken_1_2(other: com_subhuti_struct_SubhutiMatchToken): void {
    ...
    this.__qin_field_tokenTypeId = other.__qin_field_tokenTypeId;
...
class com_subhuti_struct_SubhutiMatchToken$Builder {
  ...
  constructor(...__qin_args: any[]) {
    ...
    this.__qin_field_tokenName = null;
    this.__qin_field_tokenTypeId = __qin_binary__("-", 0.0, 1.0);
    this.__qin_field_tokenValue = null;
    this.__qin_field_rowNum = null;
    this.__qin_field_columnStartNum = null;
    this.__qin_field_columnEndNum = null;
