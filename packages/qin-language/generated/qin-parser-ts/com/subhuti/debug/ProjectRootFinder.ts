...
import { __qin_builtin_constructor__, __qin_java_pattern_regexp__, __QinJavaLangString, __qin_java_functional, __qin_java_class_info__, __qin_binary__, __qin_instanceof__, __qin_logical__, __QinJavaLangSystem, __QinJavaTimeLocalDateTime, __QinJavaTimeFormatDateTimeFormatter } from "@qin/java-sdk-js";
...
class com_subhuti_debug_ProjectRootFinder {
  ...
  static findProjectRoot(): any {
    ...
    for (let i: any = 0.0; __qin_binary__("<", i, 10.0); i++) {
      ...
      return parentDir.equals(currentDir);
    })()) {
        break;
      }
