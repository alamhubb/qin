...
class com_subhuti_parser_SubhutiParserState extends com_subhuti_lookahead_SubhutiTokenLookahead {
  ...
  __qin_field_currentIndex: number | null = 0 as any;
  ...
  __qin_field_preTokenizedDefaultModeInput: boolean | null = false as any;
  ...
  __qin_field_currentTokenEntryCacheSet: boolean | null = false as any;
  __qin_field_currentTokenEntryCacheCodeIndex: number | null = 0 as any;
  __qin_field_currentTokenEntryCacheLine: number | null = 0 as any;
  __qin_field_currentTokenEntryCacheColumn: number | null = 0 as any;
  __qin_field_currentTokenEntryCacheTokenCursor: number | null = 0 as any;
  ...
  __qin_field_cstStack: __QinJavaUtilList<com_subhuti_struct_SubhutiCst> | null = null as any;
  __qin_field_rootCst: com_subhuti_struct_SubhutiCst | null = null as any;
  __qin_field_buildCst: boolean | null = false as any;
  __qin_field_ruleExecutionDepth: number | null = 0 as any;
  __qin_field_parseSuccess: boolean | null = false as any;
  __qin_field_activeRuleInvocationsByName: __QinJavaUtilHashMap<string, com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations> | null = null as any;
  __qin_field_indexedActiveRuleInvocations: com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations[] | null = null as any;
  __qin_field_indexedRuleInvocationsEnabled: boolean | null = false as any;
  __qin_field_indexedRuleInvocationLookups: number | null = 0 as any;
  __qin_field_staticPrimitiveInvocationEntries: number | null = 0 as any;
  __qin_field_staticRootRuleEntries: number | null = 0 as any;
  __qin_field_staticGateDispatches: number | null = 0 as any;
  __qin_field_staticActionDispatches: number | null = 0 as any;
  __qin_field_staticActionRetryRestores: number | null = 0 as any;
  __qin_field_staticBranchSelectorDispatches: number | null = 0 as any;
  __qin_field_staticBranchSelectorNoMatches: number | null = 0 as any;
  __qin_field_lastStaticNoMatchDecisionId: number | null = 0 as any;
  __qin_field_lastStaticAmbiguousDecisionId: number | null = 0 as any;
  ...
  __qin_field_staticBranchSelectorAmbiguities: number | null = 0 as any;
  __qin_field_staticDecisionCandidateExecutions: number | null = 0 as any;
  __qin_field_staticDecisionSkippedBranches: number | null = 0 as any;
  __qin_field_staticDecisionGateSkips: number | null = 0 as any;
  __qin_field_staticDecisionStateSaves: number | null = 0 as any;
  __qin_field_staticDecisionStateSaveSkips: number | null = 0 as any;
  __qin_field_staticDecisionDirectManyExecutions: number | null = 0 as any;
  __qin_field_staticCoreRuleEntries: number | null = 0 as any;
  __qin_field_staticRuleLoopRejects: number | null = 0 as any;
  __qin_field_staticNonNullableEmptyRejects: number | null = 0 as any;
  __qin_field_lastStaticNonNullableEmptyRule: string | null = null as any;
  __qin_field_staticExecutionModeBindings: number | null = 0 as any;
  ...
  __qin_field_enableMemoization: boolean | null = false as any;
  __qin_field_enableOrPrediction: boolean | null = false as any;
  __qin_field_debugMode: boolean | null = false as any;
  __qin_field_firstTokenRecording: boolean | null = false as any;
  __qin_field_firstTokenRecordingTokenCount: number | null = 0 as any;
  __qin_field_firstTokenRecordingMaxTokens: number | null = 0 as any;
  __qin_field_orPredictionSkippedAlternatives: number | null = 0 as any;
  __qin_field_orPredictionGateSkippedAlternatives: number | null = 0 as any;
  __qin_field_orPredictionUnknownAlternatives: number | null = 0 as any;
  __qin_field_orPredictionCandidateAlternatives: number | null = 0 as any;
  __qin_field_orPredictionStateSaves: number | null = 0 as any;
  __qin_field_orPredictionStateSaveSkips: number | null = 0 as any;
  __qin_field_orPredictionDirectManyExecutions: number | null = 0 as any;
  __qin_field_staticLl1LookaheadHits: number | null = 0 as any;
  __qin_field_staticValueAwareLl1LookaheadHits: number | null = 0 as any;
  __qin_field_staticLlkLookaheadHits: number | null = 0 as any;
  __qin_field_alternativeStartPredictionDirectOptionExecutions: number | null = 0 as any;
  __qin_field_predictionCurrentTokenCacheHits: number | null = 0 as any;
  __qin_field_predictionCurrentTokenCacheMisses: number | null = 0 as any;
  __qin_field_predictionCurrentTokenCacheSet: boolean | null = false as any;
  __qin_field_predictionCurrentTokenCacheIndex: number | null = 0 as any;
  ...
  __qin_field_analysisOnlyOrPredictionStreak: number | null = 0 as any;
  __qin_field_lastOrPredictionDebug: string | null = null as any;
  __qin_field_orPredictionDebugEnabled: boolean | null = false as any;
  __qin_field_lastOrPredictionAmbiguityDiagnostics: __QinJavaUtilList | null = null as any;
  __qin_field_lastOrPredictionRuntimePruningEnabled: boolean | null = false as any;
  ...
  __qin_field_parserRuntimePlanBuilds: number | null = 0 as any;
  __qin_field_parserRuntimePlanCacheHits: number | null = 0 as any;
  __qin_field_ruleWrapperCalls: number | null = 0 as any;
  __qin_field_ruleCoreExecutions: number | null = 0 as any;
  __qin_field_ruleCacheKeyBuilds: number | null = 0 as any;
  __qin_field_ruleCacheHits: number | null = 0 as any;
  __qin_field_ruleCachePuts: number | null = 0 as any;
  __qin_field_ruleCachePassThroughSkips: number | null = 0 as any;
  __qin_field_ruleCacheTerminalLeafSkips: number | null = 0 as any;
  __qin_field_ruleCacheSpeculativeSkips: number | null = 0 as any;
  __qin_field_ruleCacheLowYieldSkips: number | null = 0 as any;
  __qin_field_ruleCacheAdaptiveLowYieldSkips: number | null = 0 as any;
  __qin_field_ruleWrapperPassThroughSkips: number | null = 0 as any;
  __qin_field_ruleWrapperTerminalLeafSkips: number | null = 0 as any;
  __qin_field_ruleWrapperRuleChainSkips: number | null = 0 as any;
  __qin_field_ruleWrapperDirectTerminalSkips: number | null = 0 as any;
  __qin_field_ruleWrapperDirectTerminalSequenceSkips: number | null = 0 as any;
  __qin_field_ruleWrapperDirectRecognizerPlanSkips: number | null = 0 as any;
  __qin_field_tokenCacheGets: number | null = 0 as any;
  __qin_field_tokenCacheHits: number | null = 0 as any;
  __qin_field_tokenCacheMisses: number | null = 0 as any;
  __qin_field_tokenCachePuts: number | null = 0 as any;
  __qin_field_tokenStreamGets: number | null = 0 as any;
  __qin_field_tokenStreamHits: number | null = 0 as any;
  __qin_field_currentTokenEntryCacheHits: number | null = 0 as any;
  __qin_field_sourceLookaheadCacheHits: number | null = 0 as any;
  __qin_field_sourceLookaheadCacheFills: number | null = 0 as any;
  __qin_field_sourceLookaheadCacheResets: number | null = 0 as any;
  __qin_field_preTokenizedRegexpNegativeHits: number | null = 0 as any;
  __qin_field_tokenCstNodes: number | null = 0 as any;
  __qin_field_ruleCstNodes: number | null = 0 as any;
  __qin_field_cstParentRebuilds: number | null = 0 as any;
  __qin_field_cachedCstAttachCount: number | null = 0 as any;
  __qin_field_coreRuleProfileEnabled: boolean | null = false as any;
  __qin_field_staticDecisionProfileEnabled: boolean | null = false as any;
  __qin_field_staticDecisionRetryCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleWrapperCallCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCoreExecutionCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCoreSuccessCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCoreFailureCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCacheHitCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCachePutCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleCacheHitTokenSpanTotals: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_adaptiveRuleCacheHitCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_adaptiveRuleCachePutCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_adaptiveLowYieldMemoRules: __QinJavaUtilSet<string> | null = null as any;
  __qin_field_ruleWrapperPassThroughCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleWrapperTerminalLeafCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_ruleWrapperRuleChainCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_activeRuleScopeStack: __QinJavaUtilArrayDeque<string> | null = null as any;
  __qin_field_activeRuleProfileStack: __QinJavaUtilArrayDeque<string> | null = null as any;
  __qin_field_orPredictionStateSaveRuleCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_orPredictionStateSaveSkipRuleCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_orPredictionCandidateRuleCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_orPredictionCandidateRuleTotals: __QinJavaUtilHashMap<string, number | null> = null as any;
  __qin_field_preTokenizedFallbackModeCounts: __QinJavaUtilHashMap<string, number | null> = null as any;
  ...
  __qin_field_errorRecoveryMode: boolean | null = false as any;
  __qin_field_analysisMode: boolean | null = false as any;
  __qin_field_syncTokens: __QinJavaUtilSet<string> | null = null as any;
  __qin_field_partialMatchCandidates: __QinJavaUtilList | null = null as any;
  __qin_field_unparsedTokens: __QinJavaUtilList<com_subhuti_struct_SubhutiMatchToken> | null = null as any;
  __qin_field_recoveryDiagnostics: __QinJavaUtilList<com_subhuti_parser_SubhutiRecoveryDiagnostic> | null = null as any;
  __qin_field_parseRecordRoot: com_subhuti_parser_ParseRecordNode | null = null as any;
  __qin_field_parseRecordStack: __QinJavaUtilList<com_subhuti_parser_ParseRecordNode> | null = null as any;
  __qin_field_speculativeParseDepth: number | null = 0 as any;
  ...
  __qin_constructor_com_subhuti_parser_SubhutiParserState_3_0(sourceCode: string, tokenConsumerClass: __QinJavaLangClass, tokens: __QinJavaUtilList<com_subhuti_struct_SubhutiCreateToken>): void {
    ...
    this.__qin_field_indexedActiveRuleInvocations = Array.from({ length: 512.0 }, () => null);
    ...
    let vocabulary: any = com_subhuti_lexer_SubhutiLexerVocabulary.compile(tokens);
    this.__qin_field_lexer = new com_subhuti_lexer_SubhutiLexer(vocabulary);
  ...
  ruleCache(): com_subhuti_cache_SubhutiPackratCache {
  ...
  staticExecutionPlan(): com_subhuti_parser_SubhutiStaticExecutionPlan {
    if (__qin_binary__("==", this.__qin_field_staticExecutionPlan, null)) {
      let grammarPlan: com_subhuti_parser_SubhutiStaticGrammarPlan = this.staticGrammarPlan();
  ...
  tokenVocabulary(): com_subhuti_lexer_SubhutiLexerVocabulary {
    return this.__qin_field_lexer.vocabulary();
  }
  clearRuleCacheIfAllocated(): void {
    if (__qin_binary__("!=", this.__qin_field_ruleCache, null)) {
      {
        const __qin_typed_receiver_10: com_subhuti_cache_SubhutiPackratCache = this.__qin_field_ruleCache;
        __qin_typed_receiver_10.clear();
      }
    }
    return null;
  }
  ruleCacheStatsReport(): string {
    return (__qin_binary__("==", this.__qin_field_ruleCache, null) ? "PackratCache(unallocated)" : this.__qin_field_ruleCache.getStatsReport());
  }
  createTokenConsumer(clazz: __QinJavaLangClass): com_subhuti_lookahead_SubhutiTokenConsumer {
    try {
      let consumer: com_subhuti_lookahead_SubhutiTokenConsumer = clazz.getDeclaredConstructor().newInstance();
      {
        const __qin_typed_receiver_11: com_subhuti_lookahead_SubhutiTokenConsumer = consumer;
        __qin_typed_receiver_11.setParser(this);
      }
      return consumer;
    } catch (e) {
  ...
  initTopLevelData(): void {
    ...
    this.__qin_field_activeRuleInvocationsByName.values().forEach(((...__qin_args) => { const __qin_receiver = __qin_args[0]; return __qin_receiver.clear(...__qin_args.slice(1, 1)); }));
    for (const invocations of this.__qin_field_indexedActiveRuleInvocations) {
      if (__qin_binary__("!=", invocations, null)) {
        {
          const __qin_typed_receiver_12: com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations = invocations;
          __qin_typed_receiver_12.clear();
        }
      }
    }
    this.__qin_field_currentIndex = 0.0;
    ...
    this.__qin_field_tokenCursor = 0.0;
    {
      const __qin_typed_receiver_13: com_subhuti_parser_SubhutiTokenCache = this.__qin_field_tokenCache;
      __qin_typed_receiver_13.clear();
    }
    {
      const __qin_typed_receiver_14: com_subhuti_parser_SubhutiParserState = this;
      __qin_typed_receiver_14.clearCurrentTokenEntryCache();
    }
    this.__qin_field_lastTokenName = null;
    this.__qin_field_recoveryDiagnostics.clear();
    {
      const __qin_typed_receiver_15: com_subhuti_parser_SubhutiParserState = this;
      __qin_typed_receiver_15.resetCoreProfileStats();
    }
    return null;
  }
  usePreTokenizedDefaultModeInput(tokenStream: __QinJavaUtilList<com_subhuti_struct_SubhutiMatchToken>): com_subhuti_parser_SubhutiParserState {
    if (__qin_binary__("==", tokenStream, null)) {
      throw new __QinJavaLangIllegalArgumentException("tokenStream cannot be null");
    }
    let ordinalByCodeIndex: number[] = Array.from({ length: __qin_binary__("+", __QinJavaLangString.length(this.__qin_field_sourceCode), 1.0) }, () => 0);
    __QinJavaUtilArrays.fill(ordinalByCodeIndex, __qin_collection_size__(tokenStream));
    let entries: com_subhuti_lexer_TokenCacheEntry[] = Array.from({ length: __qin_collection_size__(tokenStream) }, () => null);
    let previousEnd: number = 0.0;
    for (let i: number = 0.0; __qin_binary__("<", i, __qin_collection_size__(tokenStream)); i++) {
      let token: com_subhuti_struct_SubhutiMatchToken = __qin_collection_get__(tokenStream, i);
      ...
      let tokenStart: number = token.index();
      let tokenEnd: number = token.endOffset();
      ...
      for (let codeIndex: number = Math.max(0.0, previousEnd); __qin_binary__("<", codeIndex, tokenEnd); codeIndex++) {
        ordinalByCodeIndex[codeIndex] = i;
      }
      let nextPosition: com_subhuti_struct_SubhutiPosition = this.advancePosition(token);
    ...
    {
      const __qin_typed_receiver_16: com_subhuti_parser_SubhutiTokenCache = this.__qin_field_tokenCache;
      __qin_typed_receiver_16.clear();
    }
    {
      const __qin_typed_receiver_17: com_subhuti_parser_SubhutiParserState = this;
      __qin_typed_receiver_17.clearCurrentTokenEntryCache();
    }
    return this;
  }
  useDefaultModeTokenArrayInput(): com_subhuti_parser_SubhutiParserState {
    return this.usePreTokenizedDefaultModeInput(this.__qin_field_lexer.tokenize(this.__qin_field_sourceCode));
  }
  isUsingDefaultModeTokenArrayInput(): boolean {
    return this.__qin_field_preTokenizedDefaultModeInput;
  }
  clearCurrentTokenEntryCache(): void {
    this.__qin_field_currentTokenEntryCacheSet = false;
    this.__qin_field_currentTokenEntryCacheCodeIndex = __qin_binary__("-", 0.0, 1.0);
    this.__qin_field_currentTokenEntryCacheLine = __qin_binary__("-", 0.0, 1.0);
    this.__qin_field_currentTokenEntryCacheColumn = __qin_binary__("-", 0.0, 1.0);
  ...
  preTokenizedEntryAt(codeIndex: number, mode: com_subhuti_struct_LexerMode): com_subhuti_lexer_TokenCacheEntry {
    ...
    let ordinal: number = this.__qin_field_preTokenizedOrdinalByCodeIndex[codeIndex];
  ...
  preTokenizedEntryAtParsedOrdinal(offset: number, mode: com_subhuti_struct_LexerMode): com_subhuti_lexer_TokenCacheEntry {
    ...
    let ordinal: number = __qin_binary__("-", __qin_binary__("+", this.__qin_field_tokenCursor, offset), 1.0);
    if ((__qin_binary__("<", ordinal, 0.0) || __qin_binary__(">=", ordinal, this.__qin_field_preTokenizedEntriesByOrdinal.length))) {
      return null;
    }
    if (__qin_binary__("<", this.__qin_field_tokenCursor, this.__qin_field_preTokenizedEntriesByOrdinal.length)) {
      let currentEntry: com_subhuti_lexer_TokenCacheEntry = this.__qin_field_preTokenizedEntriesByOrdinal[this.__qin_field_tokenCursor];
      let currentToken: com_subhuti_struct_SubhutiMatchToken = (__qin_binary__("!=", currentEntry, null) ? currentEntry.getToken() : null);
      let currentTokenStart: number | null = (__qin_binary__("!=", currentToken, null) ? currentToken.index() : null);
      if ((__qin_binary__("!=", currentTokenStart, null) && __qin_binary__("<", currentTokenStart, this.__qin_field_currentIndex))) {
        return null;
      }
    }
    let entry: com_subhuti_lexer_TokenCacheEntry = this.__qin_field_preTokenizedEntriesByOrdinal[ordinal];
  ...
  tokenOrdinalAtCodeIndex(codeIndex: number): number {
    ...
    let boundedIndex: number = Math.max(0.0, Math.min(codeIndex, __qin_binary__("-", this.__qin_field_preTokenizedOrdinalByCodeIndex.length, 1.0)));
    return this.__qin_field_preTokenizedOrdinalByCodeIndex[boundedIndex];
  }
  advanceTokenCursor(entry: com_subhuti_lexer_TokenCacheEntry): void {
    ...
    {
      const __qin_typed_receiver_18: com_subhuti_parser_SubhutiParserState = this;
      __qin_typed_receiver_18.clearCurrentTokenEntryCache();
    }
    return null;
  }
  cursorStamp(): number {
    return __qin_binary__("<<", (this.__qin_field_tokenCursor | 0), 32.0);
  }
  advancePosition(token: com_subhuti_struct_SubhutiMatchToken): com_subhuti_struct_SubhutiPosition {
    let value: string = token.tokenValue();
    let line: number = token.rowNum();
    let column: number = token.columnStartNum();
    let lineBreaks: number = this.countLineBreaks(value);
    ...
    let lastBreakIndex: number = value.lastIndexOf("\n");
  ...
  countLineBreaks(text: string): number {
    ...
    for (let i: number = 0.0; __qin_binary__("<", i, __QinJavaLangString.length(text)); i++) {
  ...
  saveState(): com_subhuti_parser_SubhutiBackData {
    if ((!this.__qin_field_buildCst && __qin_collection_is_empty__(this.__qin_field_parsedTokens))) {
  ...
  restoreState(state: com_subhuti_parser_SubhutiBackData): void {
    ...
    if ((__qin_binary__("!=", currentCst, null) && __qin_binary__(">", currentCst.getChildCount(), state.curCstChildrenLength()))) {
      let children: __QinJavaUtilList<com_subhuti_struct_SubhutiCst> = currentCst.getChildren();
      while (__qin_binary__(">", __qin_collection_size__(children), state.curCstChildrenLength())) {
        children.remove(__qin_binary__("-", __qin_collection_size__(children), 1.0));
      }
    }
    while (__qin_binary__(">", __qin_collection_size__(this.__qin_field_parsedTokens), state.parsedTokensLength())) {
      this.__qin_field_parsedTokens.remove(__qin_binary__("-", __qin_collection_size__(this.__qin_field_parsedTokens), 1.0));
    }
    return null;
  }
  getCurCst(): com_subhuti_struct_SubhutiCst {
    if (__qin_collection_is_empty__(this.__qin_field_cstStack)) {
      return null;
    }
    return __qin_collection_get__(this.__qin_field_cstStack, __qin_binary__("-", __qin_collection_size__(this.__qin_field_cstStack), 1.0));
  }
  getCst(): com_subhuti_struct_SubhutiCst {
    return this.__qin_field_rootCst;
  }
  setLocation(cst: com_subhuti_struct_SubhutiCst): void {
    if ((__qin_binary__("!=", cst.getChildren(), null) && !__qin_collection_is_empty__(cst.getChildren()))) {
      ...
      let lastChild: com_subhuti_struct_SubhutiCst = __qin_collection_get__(cst.getChildren(), __qin_binary__("-", __qin_collection_size__(cst.getChildren()), 1.0));
      if ((__qin_binary__("!=", firstChild.getLocation(), null) && __qin_binary__("!=", lastChild.getLocation(), null))) {
        let location: com_subhuti_struct_SubhutiSourceLocation = com_subhuti_struct_SubhutiSourceLocation.of(firstChild.getLocation().start(), lastChild.getLocation().end());
        {
          const __qin_typed_receiver_19: com_subhuti_struct_SubhutiCst = cst;
          __qin_typed_receiver_19.setLocation(location);
        }
      }
    }
    return null;
  ...
  setParseSuccess(): void {
    this.__qin_field_parseSuccess = true;
    this.__qin_field__parseSuccess = true;
    return null;
  }
  getCurrentPosition(): com_subhuti_struct_SubhutiPosition {
  ...
  setSyncTokens(...tokens: string[]): com_subhuti_parser_SubhutiParserState {
  ...
  addSyncTokens(...tokens: string[]): com_subhuti_parser_SubhutiParserState {
    if (__qin_binary__("!=", tokens, null)) {
      for (const token of tokens) {
        this.__qin_field_syncTokens.add(token);
      }
  ...
  enableErrorRecovery(): com_subhuti_parser_SubhutiParserState {
    this.__qin_field_errorRecoveryMode = true;
    if (__qin_collection_is_empty__(this.__qin_field_syncTokens)) {
      {
        const __qin_typed_receiver_20: com_subhuti_parser_SubhutiParserState = this;
        __qin_typed_receiver_20.addSyncTokens("LetTok", "ConstTok", "VarTok", "FunctionTok", "ClassTok", "AsyncTok", "IfTok", "ForTok", "WhileTok", "DoTok", "SwitchTok", "TryTok", "ThrowTok", "ReturnTok", "BreakTok", "ContinueTok", "ImportTok", "ExportTok", "DebuggerTok", "Semicolon");
      }
    }
    return this;
  }
  isErrorRecoveryMode(): boolean {
    return this.__qin_field_errorRecoveryMode;
  }
  getUnparsedTokens(): __QinJavaUtilList<com_subhuti_struct_SubhutiMatchToken> {
    return new __QinJavaUtilArrayList(this.__qin_field_unparsedTokens);
  }
  hasUnparsedTokens(): boolean {
    return (!__qin_collection_is_empty__(this.__qin_field_unparsedTokens));
  }
  getRecoveryDiagnostics(): __QinJavaUtilList<com_subhuti_parser_SubhutiRecoveryDiagnostic> {
    return new __QinJavaUtilArrayList(this.__qin_field_recoveryDiagnostics);
  }
  hasRecoveryDiagnostics(): boolean {
    return (!__qin_collection_is_empty__(this.__qin_field_recoveryDiagnostics));
  }
  recordRecoveryDiagnostic(...__qin_args: any[]): void {
  ...
  __qin_overload_recordRecoveryDiagnostic_2_0(message: string, token: com_subhuti_struct_SubhutiMatchToken): void {
  ...
  __qin_overload_recordRecoveryDiagnostic_3_1(message: string, start: com_subhuti_struct_SubhutiPosition, end: com_subhuti_struct_SubhutiPosition): void {
  ...
  analysisMode(enable: boolean): com_subhuti_parser_SubhutiParserState {
  ...
  errorHandler(enable: boolean): com_subhuti_parser_SubhutiParserState {
  ...
  getErrorHandler(): com_subhuti_error_SubhutiErrorHandler {
    return this.__qin_field_errorHandler;
  }
  getRuleStack(): __QinJavaUtilList<string> {
    let ruleStack: __QinJavaUtilList<string> = new __QinJavaUtilArrayList();
  ...
  shouldStoreParsedTokens(): boolean {
...
class com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations {
  ...
  __qin_field_size: number | null = 0 as any;
  constructor(...__qin_args: any[]) {
    ...
    this.__qin_field_cacheKeyExtras = Array.from({ length: 2.0 }, () => null);
    this.__qin_field_cursorStamps = Array.from({ length: 2.0 }, () => 0);
    this.__qin_field_modes = Array.from({ length: 2.0 }, () => null);
    this.__qin_field_lastTokenNames = Array.from({ length: 2.0 }, () => null);
    this.__qin_field_size = 0;
  }
  enter(cacheKeyExtra: any, cursorStamp: number, mode: com_subhuti_struct_LexerMode, lastTokenName: string): boolean {
    let normalizedExtra: any = (__qin_binary__("==", cacheKeyExtra, null) ? "" : cacheKeyExtra);
    for (let i: number = 0.0; __qin_binary__("<", i, this.__qin_field_size); i++) {
    ...
    {
      const __qin_typed_receiver_21: com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations = this;
      __qin_typed_receiver_21.ensureCapacity(__qin_binary__("+", this.__qin_field_size, 1.0));
    }
  ...
  exit(): void {
    let index: number = --this.__qin_field_size;
  ...
  clear(): void {
    while (__qin_binary__(">", this.__qin_field_size, 0.0)) {
      {
        const __qin_typed_receiver_22: com_subhuti_parser_SubhutiParserState$ActiveRuleInvocations = this;
        __qin_typed_receiver_22.exit();
      }
    }
    return null;
  }
  ensureCapacity(capacity: number): void {
    ...
    let newCapacity: number = __qin_binary__("*", this.__qin_field_cursorStamps.length, 2.0);
