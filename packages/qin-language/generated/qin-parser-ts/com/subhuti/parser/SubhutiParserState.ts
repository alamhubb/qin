...
class com_subhuti_parser_SubhutiParserState extends com_subhuti_lookahead_SubhutiTokenLookahead {
  ...
  hasRecoveryDiagnostics(): any {
    return (() => {
      if (__QinJavaLangString.isEmpty(this.__qin_field_recoveryDiagnostics)) {
        return false;
      }
      return true;
    })();
  ...
  recordRecoveryDiagnostic(...__qin_args: any[]): any {
    if (__qin_args.length === 2 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_args[1] instanceof com_subhuti_struct_SubhutiMatchToken)) return this.__qin_overload_recordRecoveryDiagnostic_2_0(__qin_args[0], __qin_args[1]);
    if (__qin_args.length === 3 && (__qin_args[0] === null || typeof __qin_args[0] === "string") && (__qin_args[1] === null || __qin_args[1] instanceof com_subhuti_struct_SubhutiPosition) && (__qin_args[2] === null || __qin_args[2] instanceof com_subhuti_struct_SubhutiPosition)) return this.__qin_overload_recordRecoveryDiagnostic_3_1(__qin_args[0], __qin_args[1], __qin_args[2]);
