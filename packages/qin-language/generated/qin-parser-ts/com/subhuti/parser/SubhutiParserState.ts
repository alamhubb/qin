...
class com_subhuti_parser_SubhutiParserState extends com_subhuti_lookahead_SubhutiTokenLookahead {
  ...
  __qin_field_firstTokenRecordingTokenName: string | null = null as any;
  __qin_field_firstTokenRecordingTokenNames: any = null as any;
  __qin_field_firstTokenRecordingLexerModes: any = null as any;
  __qin_field_firstTokenRecordingGrammarNodes: any = null as any;
  ...
  __qin_field_hotOrPredictionKind: string | null = null as any;
  __qin_field_hotOrPredictionIdentityClasses: any[] | null = null as any;
  __qin_field_hotOrPredictionKey: string | null = null as any;
  __qin_field_hotOrPrediction: com_subhuti_parser_SubhutiOrPrediction | null = null as any;
  ...
  __qin_constructor_com_subhuti_parser_SubhutiParserState_3(sourceCode: string, tokenConsumerClass: any, tokens: any): void {
    ...
    this.__qin_field_firstTokenRecordingTokenNames = new __QinJavaUtilArrayList();
    this.__qin_field_firstTokenRecordingLexerModes = new __QinJavaUtilArrayList();
    this.__qin_field_firstTokenRecordingGrammarNodes = new __QinJavaUtilArrayList();
    ...
    this.__qin_field_hotOrPredictionKind = null;
    this.__qin_field_hotOrPredictionIdentityClasses = null;
    this.__qin_field_hotOrPredictionKey = null;
    this.__qin_field_hotOrPrediction = null;
  ...
  enableErrorRecovery(): any {
    ...
    if (this.__qin_field_syncTokens.isEmpty()) {
  ...
  hasRecoveryDiagnostics(): any {
    return (() => {
      if (this.__qin_field_recoveryDiagnostics.isEmpty()) {
        return false;
      }
      return true;
    })();
  ...
  lastTokenIndex(): any {
    return (() => {
      if (this.__qin_field_parsedTokens.isEmpty()) {
  ...
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 0: {
        ...
        this.__qin_constructor_com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenRecordedException_0();
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: SubhutiParserState$SubhutiFirstTokenRecordedException/" + __qin_args.length);
    }
  }
  __qin_constructor_com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenRecordedException_0(): void {
    null;
  }
}
...
class com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenUnknownException extends java_lang_Error {
  constructor(...__qin_args: any[]) {
    switch (__qin_args.length) {
      case 0: {
        super(null, null, false, false);
        this.__qin_constructor_com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenUnknownException_0();
        return;
      }
      default: throw new Error("Unsupported Java constructor arity: SubhutiParserState$SubhutiFirstTokenUnknownException/" + __qin_args.length);
    }
  }
  __qin_constructor_com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenUnknownException_0(): void {
    null;
  }
}
...
export { com_subhuti_parser_SubhutiParserState, com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenRecordedException, com_subhuti_parser_SubhutiParserState$SubhutiFirstTokenUnknownException };
