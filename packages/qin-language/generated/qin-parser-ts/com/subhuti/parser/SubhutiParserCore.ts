...
class com_subhuti_parser_SubhutiParserCore extends com_subhuti_parser_SubhutiParserState {
  ...
  recordPredictionToken(tokenName: string, mode: com_subhuti_struct_LexerMode): any {
    if (this.__qin_field_firstTokenRecordingTokenNames.isEmpty()) {
      this.__qin_field_firstTokenRecordingTokenName = tokenName;
    }
    this.__qin_field_firstTokenRecordingTokenNames.add(tokenName);
    this.__qin_field_firstTokenRecordingLexerModes.add((() => {
      if (__qin_binary__("==", mode, null)) {
        return com_subhuti_struct_LexerMode.__qin_field_DEFAULT_MODE;
      }
      return mode;
    })());
    this.__qin_field_firstTokenRecordingGrammarNodes.add(com_subhuti_parser_SubhutiGrammarNode.terminal(tokenName));
    return null;
  }
  _consumeToken(tokenName: string, mode: com_subhuti_struct_LexerMode): any {
    if (this.__qin_field_firstTokenRecording) {
      this.recordPredictionToken(tokenName, mode);
      if (__qin_binary__(">=", this.__qin_field_firstTokenRecordingTokenNames.size(), this.__qin_field_firstTokenRecordingMaxTokens)) {
  ...
  recordConsumedToken(token: com_subhuti_struct_SubhutiMatchToken): any {
    if ((() => {
      ...
      return this.__qin_field_parseRecordStack.isEmpty();
    })()) {
      return null;
    }
  ...
  __qin_overload_executeRuleWrapper_4_1(targetFun: any, ruleName: string, className: string, cacheKeyExtra: string): any {
    ...
    if (this.__qin_field_firstTokenRecording) {
      ...
      try {
        ...
        this.__qin_field_firstTokenRecordingGrammarNodes.add(com_subhuti_parser_SubhutiGrammarNode.nonTerminal(ruleName, children));
      }
    }
    let isTopLevel: any = this.__qin_field_cstStack.isEmpty();
    if (isTopLevel) {
    ...
    try {
      if (this.__qin_field_enableMemoization) {
        ...
        if (cached.isPresent()) {
          ...
          if ((() => {
      if (this.isErrorRecoveryMode()) {
        return (() => { const __qin_instanceof_value = cached.get(); return __qin_instanceof__(__qin_instanceof_value, com_subhuti_cache_SubhutiPackratCacheResult); })();
      }
      return false;
    })()) {
      ...
      if (this.__qin_field_parseRecordStack.isEmpty()) {
        return null;
      }
  ...
  applyCachedResult(cached: any): any {
    ...
    if ((() => {
      if (__qin_binary__("!=", cacheResult.__qin_field_parsedTokens, null)) {
        return (() => {
      if (cacheResult.__qin_field_parsedTokens.isEmpty()) {
        return false;
      }
      return true;
    })();
    ...
    if ((() => {
      if (cacheResult.__qin_field_parseSuccess) {
        return (() => { const __qin_instanceof_value = cacheResult.__qin_field_cst; return __qin_instanceof__(__qin_instanceof_value, com_subhuti_struct_SubhutiCst); })();
      }
      return false;
    })()) {
