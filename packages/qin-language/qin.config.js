export default {
  ...
  scripts: {
    ...
    test: "tsx tests/test-language-plugin.ts && tsx tests/test-generated-parser-parity.ts && tsx tests/test-language-server-metadata.ts && tsdown && tsx tests/test-language-server.ts",
