...
import { com_subhuti_cache_SubhutiPackratCacheResult } from "../cache/SubhutiPackratCacheResult.ts";
import { com_subhuti_debug_SubhutiTraceDebugger } from "../debug/SubhutiTraceDebugger.ts";
...
import { com_subhuti_struct_SubhutiSourceLocation, com_subhuti_struct_SubhutiSourceLocation$Builder } from "../struct/SubhutiSourceLocation.ts";
...
class com_subhuti_parser_SubhutiParserCore extends com_subhuti_parser_SubhutiParserState {
  ...
  executeRuleWrapper(...__qin_args: any[]): any {
    ...
    if (__qin_args.length === 4 && (__qin_args[0] === null || typeof __qin_args[0] === "function" || __qin_args[0].__qinJavaFunctional === true) && (__qin_args[1] === null || typeof __qin_args[1] === "string") && (__qin_args[2] === null || typeof __qin_args[2] === "string") && (__qin_args[3] === null || typeof __qin_args[3] === "string")) return this.__qin_overload_executeRuleWrapper_4_1(...__qin_args);
