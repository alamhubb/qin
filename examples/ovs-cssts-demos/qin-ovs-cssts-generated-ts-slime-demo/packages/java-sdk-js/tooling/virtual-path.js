...
export class __QinJavaIoFile {
  constructor(...__qin_args) {
    const pathOrParent = __qin_args.length > 0 ? __qin_args[0] : null;
    const child = __qin_args.length > 1 ? __qin_args[1] : null;
    if (__qin_args.length >= 2) {
...
export class __QinJavaNioFilePath {
  ...
  getParent() {
    ...
    return __qin_parent == null ? null : new __QinJavaNioFilePath(__qin_parent.getPath());
  }
  toString() {
    return this.__path;
  }
