...
- Java interop import tables in IDEA should be derived from Qin PSI/parser adapter tokens, not regex scanning over the full source text. Until full Qin AST-backed PSI is available, a token-stream adapter is the acceptable transitional boundary.
